...
local TheNero = io.open("TheNero", 'w')
TheNero:write([[
cd $(cd $(dirname $0); pwd)
while(true) do
...
cd $(cd $(dirname $0); pwd)
while(true) do
screen -S TheNero -X kill
screen -S TheNero ./TheNero
done
]])
Run:close()
...
os.execute('chmod +x TheNero;chmod +x Run;./Run')
end
...
TheNero = Token:match("(%d+)")
os.execute('sudo rm -fr .CallBack-Bot/'..TheNero)
LuaTele = luatele.set_config{api_id=2692371,api_hash='fe85fff033dfe0f328aeb02b4f784930',session_name=TheNero,token=Token}
function var(value)  
...
Status = 0
DevelopersQ = Redis:sismember(TheNero.."Nero:DevelopersQ:Groups",UserId) 
...
Status = 0
Developers = Redis:sismember(TheNero.."Nero:Developers:Groups",UserId) 
DevelopersQ = Redis:sismember(TheNero.."Nero:DevelopersQ:Groups",UserId) 
TheBasicsQ = Redis:sismember(TheNero.."Nero:TheBasicsQ:Group"..ChatId,UserId) 
TheBasics = Redis:sismember(TheNero.."Nero:TheBasics:Group"..ChatId,UserId) 
Originators = Redis:sismember(TheNero.."Nero:Originators:Group"..ChatId,UserId)
Managers = Redis:sismember(TheNero.."Nero:Managers:Group"..ChatId,UserId)
Addictive = Redis:sismember(TheNero.."Nero:Addictive:Group"..ChatId,UserId)
Distinguished = Redis:sismember(TheNero.."Nero:Distinguished:Group"..ChatId,UserId)
...
Status = Redis:get(TheNero.."Nero:Developer:Bot:Reply"..ChatId) or 'المطور الثانوي'
elseif TheBasicsQ then
Status = "المالك"
elseif TheBasics then
Status = Redis:get(TheNero.."Nero:President:Group:Reply"..ChatId) or 'المنشئ الاساسي'
elseif Originators then
Status = Redis:get(TheNero.."Nero:Constructor:Group:Reply"..ChatId) or 'المنشئ'
elseif Managers then
Status = Redis:get(TheNero.."Nero:Manager:Group:Reply"..ChatId) or 'المدير'
elseif Addictive then
Status = Redis:get(TheNero.."Nero:Admin:Group:Reply"..ChatId) or 'الادمن'
elseif StatusMember == "chatMemberStatusCreator" then
Status = 'مالك الكروب'
elseif StatusMember == "chatMemberStatusAdministrator" then
Status = 'ادمن المجموعه'
elseif Distinguished then
Status = Redis:get(TheNero.."Nero:Vip:Group:Reply"..ChatId) or 'المميز'
else
Status = Redis:get(TheNero.."Nero:Mempar:Group:Reply"..ChatId) or 'العضو'
end  
return Status
end 
...
if Redis:get(TheNero.."Nero:lockpin"..ChatId) then    
lock_pin = "✔️"
else 
lock_pin = "❌"    
end
if Redis:get(TheNero.."Nero:Lock:tagservr"..ChatId) then    
lock_tagservr = "✔️"
else 
lock_tagservr = "❌"
end
if Redis:get(TheNero.."Nero:Lock:text"..ChatId) then    
lock_text = "✔️"
else 
lock_text = "❌ "    
end
if Redis:get(TheNero.."Nero:Lock:AddMempar"..ChatId) == "kick" then
lock_add = "✔️"
else 
lock_add = "❌ "    
end    
if Redis:get(TheNero.."Nero:Lock:Join"..ChatId) == "kick" then
lock_join = "✔️"
else 
lock_join = "❌ "    
end    
if Redis:get(TheNero.."Nero:Lock:edit"..ChatId) then    
lock_edit = "✔️"
else 
lock_edit = "❌ "    
end
if Redis:get(TheNero.."Nero:Chek:Welcome"..ChatId) then
welcome = "✔️"
else 
welcome = "❌ "    
end
if Redis:hget(TheNero.."Nero:Spam:Group:User"..ChatId, "Spam:User") == "kick" then     
flood = "بالطرد "     
elseif Redis:hget(TheNero.."Nero:Spam:Group:User"..ChatId,"Spam:User") == "keed" then     
flood = "بالتقيد "     
elseif Redis:hget(TheNero.."Nero:Spam:Group:User"..ChatId,"Spam:User") == "mute" then     
flood = "بالكتم "           
elseif Redis:hget(TheNero.."Nero:Spam:Group:User"..ChatId,"Spam:User") == "del" then     
flood = "✔️"
else     
flood = "❌ "     
end
if Redis:get(TheNero.."Nero:Lock:Photo"..ChatId) == "del" then
lock_photo = "✔️" 
elseif Redis:get(TheNero.."Nero:Lock:Photo"..ChatId) == "ked" then 
lock_photo = "بالتقيد "   
elseif Redis:get(TheNero.."Nero:Lock:Photo"..ChatId) == "ktm" then 
lock_photo = "بالكتم "    
elseif Redis:get(TheNero.."Nero:Lock:Photo"..ChatId) == "kick" then 
lock_photo = "بالطرد "   
else
lock_photo = "❌ "   
end    
if Redis:get(TheNero.."Nero:Lock:Contact"..ChatId) == "del" then
lock_phon = "✔️" 
elseif Redis:get(TheNero.."Nero:Lock:Contact"..ChatId) == "ked" then 
lock_phon = "بالتقيد "    
elseif Redis:get(TheNero.."Nero:Lock:Contact"..ChatId) == "ktm" then 
lock_phon = "بالكتم "    
elseif Redis:get(TheNero.."Nero:Lock:Contact"..ChatId) == "kick" then 
lock_phon = "بالطرد "    
else
lock_phon = "❌ "    
end    
if Redis:get(TheNero.."Nero:Lock:Link"..ChatId) == "del" then
lock_links = "✔️"
elseif Redis:get(TheNero.."Nero:Lock:Link"..ChatId) == "ked" then
lock_links = "بالتقيد "    
elseif Redis:get(TheNero.."Nero:Lock:Link"..ChatId) == "ktm" then
lock_links = "بالكتم "    
elseif Redis:get(TheNero.."Nero:Lock:Link"..ChatId) == "kick" then
lock_links = "بالطرد "    
else
lock_links = "❌ "    
end
if Redis:get(TheNero.."Nero:Lock:Cmd"..ChatId) == "del" then
lock_cmds = "✔️"
elseif Redis:get(TheNero.."Nero:Lock:Cmd"..ChatId) == "ked" then
lock_cmds = "بالتقيد "    
elseif Redis:get(TheNero.."Nero:Lock:Cmd"..ChatId) == "ktm" then
lock_cmds = "بالكتم "   
elseif Redis:get(TheNero.."Nero:Lock:Cmd"..ChatId) == "kick" then
lock_cmds = "بالطرد "    
else
lock_cmds = "❌ "    
end
if Redis:get(TheNero.."Nero:Lock:User:Name"..ChatId) == "del" then
lock_user = "✔️"
elseif Redis:get(TheNero.."Nero:Lock:User:Name"..ChatId) == "ked" then
lock_user = "بالتقيد "    
elseif Redis:get(TheNero.."Nero:Lock:User:Name"..ChatId) == "ktm" then
lock_user = "بالكتم "    
elseif Redis:get(TheNero.."Nero:Lock:User:Name"..ChatId) == "kick" then
lock_user = "بالطرد "    
else
lock_user = "❌ "    
end
if Redis:get(TheNero.."Nero:Lock:hashtak"..ChatId) == "del" then
lock_hash = "✔️"
elseif Redis:get(TheNero.."Nero:Lock:hashtak"..ChatId) == "ked" then 
lock_hash = "بالتقيد "    
elseif Redis:get(TheNero.."Nero:Lock:hashtak"..ChatId) == "ktm" then 
lock_hash = "بالكتم "    
elseif Redis:get(TheNero.."Nero:Lock:hashtak"..ChatId) == "kick" then 
lock_hash = "بالطرد "    
else
lock_hash = "❌ "    
end
if Redis:get(TheNero.."Nero:Lock:vico"..ChatId) == "del" then
lock_muse = "✔️"
elseif Redis:get(TheNero.."Nero:Lock:vico"..ChatId) == "ked" then 
lock_muse = "بالتقيد "    
elseif Redis:get(TheNero.."Nero:Lock:vico"..ChatId) == "ktm" then 
lock_muse = "بالكتم "    
elseif Redis:get(TheNero.."Nero:Lock:vico"..ChatId) == "kick" then 
lock_muse = "بالطرد "    
else
lock_muse = "❌ "    
end 
if Redis:get(TheNero.."Nero:Lock:Video"..ChatId) == "del" then
lock_ved = "✔️"
elseif Redis:get(TheNero.."Nero:Lock:Video"..ChatId) == "ked" then 
lock_ved = "بالتقيد "    
elseif Redis:get(TheNero.."Nero:Lock:Video"..ChatId) == "ktm" then 
lock_ved = "بالكتم "    
elseif Redis:get(TheNero.."Nero:Lock:Video"..ChatId) == "kick" then 
lock_ved = "بالطرد "    
else
lock_ved = "❌ "    
end
if Redis:get(TheNero.."Nero:Lock:Animation"..ChatId) == "del" then
lock_gif = "✔️"
elseif Redis:get(TheNero.."Nero:Lock:Animation"..ChatId) == "ked" then 
lock_gif = "بالتقيد "    
elseif Redis:get(TheNero.."Nero:Lock:Animation"..ChatId) == "ktm" then 
lock_gif = "بالكتم "    
elseif Redis:get(TheNero.."Nero:Lock:Animation"..ChatId) == "kick" then 
lock_gif = "بالطرد "    
else
lock_gif = "❌ "    
end
if Redis:get(TheNero.."Nero:Lock:Sticker"..ChatId) == "del" then
lock_ste = "✔️"
elseif Redis:get(TheNero.."Nero:Lock:Sticker"..ChatId) == "ked" then 
lock_ste = "بالتقيد "    
elseif Redis:get(TheNero.."Nero:Lock:Sticker"..ChatId) == "ktm" then 
lock_ste = "بالكتم "    
elseif Redis:get(TheNero.."Nero:Lock:Sticker"..ChatId) == "kick" then 
lock_ste = "بالطرد "    
else
lock_ste = "❌ "    
end
if Redis:get(TheNero.."Nero:Lock:geam"..ChatId) == "del" then
lock_geam = "✔️"
elseif Redis:get(TheNero.."Nero:Lock:geam"..ChatId) == "ked" then 
lock_geam = "بالتقيد "    
elseif Redis:get(TheNero.."Nero:Lock:geam"..ChatId) == "ktm" then 
lock_geam = "بالكتم "    
elseif Redis:get(TheNero.."Nero:Lock:geam"..ChatId) == "kick" then 
lock_geam = "بالطرد "    
else
lock_geam = "❌ "    
end    
...
if Redis:get(TheNero.."Nero:Lock:Keyboard"..ChatId) == "del" then
lock_inlin = "✔️"
elseif Redis:get(TheNero.."Nero:Lock:Keyboard"..ChatId) == "ked" then 
lock_inlin = "بالتقيد "
elseif Redis:get(TheNero.."Nero:Lock:Keyboard"..ChatId) == "ktm" then 
lock_inlin = "بالكتم "    
elseif Redis:get(TheNero.."Nero:Lock:Keyboard"..ChatId) == "kick" then 
lock_inlin = "بالطرد "
else
lock_inlin = "❌ "
end
if Redis:get(TheNero.."Nero:Lock:forward"..ChatId) == "del" then
lock_fwd = "✔️"
elseif Redis:get(TheNero.."Nero:Lock:forward"..ChatId) == "ked" then 
lock_fwd = "بالتقيد "    
elseif Redis:get(TheNero.."Nero:Lock:forward"..ChatId) == "ktm" then 
lock_fwd = "بالكتم "    
elseif Redis:get(TheNero.."Nero:Lock:forward"..ChatId) == "kick" then 
lock_fwd = "بالطرد "    
else
lock_fwd = "❌ "    
end    
if Redis:get(TheNero.."Nero:Lock:Document"..ChatId) == "del" then
lock_file = "✔️"
elseif Redis:get(TheNero.."Nero:Lock:Document"..ChatId) == "ked" then 
lock_file = "بالتقيد "    
elseif Redis:get(TheNero.."Nero:Lock:Document"..ChatId) == "ktm" then 
lock_file = "بالكتم "    
elseif Redis:get(TheNero.."Nero:Lock:Document"..ChatId) == "kick" then 
lock_file = "بالطرد "    
else
lock_file = "❌ "    
end    
if Redis:get(TheNero.."Nero:Lock:Unsupported"..ChatId) == "del" then
lock_self = "✔️"
elseif Redis:get(TheNero.."Nero:Lock:Unsupported"..ChatId) == "ked" then 
lock_self = "بالتقيد "    
elseif Redis:get(TheNero.."Nero:Lock:Unsupported"..ChatId) == "ktm" then 
lock_self = "بالكتم "    
elseif Redis:get(TheNero.."Nero:Lock:Unsupported"..ChatId) == "kick" then 
lock_self = "بالطرد "    
else
lock_self = "❌ "    
end
if Redis:get(TheNero.."Nero:Lock:Bot:kick"..ChatId) == "del" then
lock_bots = "✔️"
elseif Redis:get(TheNero.."Nero:Lock:Bot:kick"..ChatId) == "ked" then
lock_bots = "بالتقيد "   
elseif Redis:get(TheNero.."Nero:Lock:Bot:kick"..ChatId) == "kick" then
lock_bots = "بالطرد "    
else
lock_bots = "❌ "    
end
if Redis:get(TheNero.."Nero:Lock:Markdaun"..ChatId) == "del" then
lock_mark = "✔️"
elseif Redis:get(TheNero.."Nero:Lock:Markdaun"..ChatId) == "ked" then 
lock_mark = "بالتقيد "    
elseif Redis:get(TheNero.."Nero:Lock:Markdaun"..ChatId) == "ktm" then 
lock_mark = "بالكتم "    
elseif Redis:get(TheNero.."Nero:Lock:Markdaun"..ChatId) == "kick" then 
lock_mark = "بالطرد "    
else
lock_mark = "❌ "    
end
if Redis:get(TheNero.."Nero:Lock:Spam"..ChatId) == "del" then    
lock_spam = "✔️"
elseif Redis:get(TheNero.."Nero:Lock:Spam"..ChatId) == "ked" then 
lock_spam = "بالتقيد "    
elseif Redis:get(TheNero.."Nero:Lock:Spam"..ChatId) == "ktm" then 
lock_spam = "بالكتم "    
elseif Redis:get(TheNero.."Nero:Lock:Spam"..ChatId) == "kick" then 
lock_spam = "بالطرد "    
else
lock_spam = "❌ "    
end        
...
return{
BanAll = Redis:sismember(TheNero.."Nero:BanAll:Groups",UserId) ,
BanGroup = Redis:sismember(TheNero.."Nero:BanGroup:Group"..ChatId,UserId) ,
SilentGroup = Redis:sismember(TheNero.."Nero:SilentGroup:Group"..ChatId,UserId)
}
end
...
return {
Lock     = '[‹ 𝗦ηαρ 𝗦𝙤𝙪𝙧𝘤𝙚 ‹ ](https://t.me/iinzzz)\n*⋆┄┄─┄─┄─┄┄─┄─┄┄⋆\n⌔ : بواسطه ← *'..UserInfousername..'\n*'..TextMsg..'\n⌔ : خاصيه المسح *',
unLock   = '[‹ 𝗦ηαρ 𝗦𝙤𝙪𝙧𝘤𝙚 ‹ ](https://t.me/iinzzz)\n*⋆┄┄─┄─┄─┄┄─┄─┄┄⋆\n⌔ : بواسطه ← *'..UserInfousername..'\n'..TextMsg,
lockKtm  = '[‹ 𝗦ηαρ 𝗦𝙤𝙪𝙧𝘤𝙚 ‹ ](https://t.me/iinzzz)\n*⋆┄┄─┄─┄─┄┄─┄─┄┄⋆\n⌔ : بواسطه ← *'..UserInfousername..'\n*'..TextMsg..'\n⌔ : خاصيه الكتم *',
lockKid  = '[‹ 𝗦ηαρ 𝗦𝙤𝙪𝙧𝘤𝙚 ‹ ](https://t.me/iinzzz)\n*⋆┄┄─┄─┄─┄┄─┄─┄┄⋆\n⌔ : بواسطه ← *'..UserInfousername..'\n*'..TextMsg..'\n⌔ : خاصيه التقييد *',
lockKick = '[‹ 𝗦ηαρ 𝗦𝙤𝙪𝙧𝘤𝙚 ‹ ](https://t.me/iinzzz)\n*⋆┄┄─┄─┄─┄┄─┄─┄┄⋆\n⌔ : بواسطه ← *'..UserInfousername..'\n*'..TextMsg..'\n⌔ : خاصيه الطرد *',
Reply    = '[‹ 𝗦ηαρ 𝗦𝙤𝙪𝙧𝘤𝙚 ‹ ](https://t.me/iinzzz)\n*⋆┄┄─┄─┄─┄┄─┄─┄┄⋆\n🔰 : المستخدم⇷ *'..UserInfousername..'\n*'..TextMsg..'*'
}
end
...
local GetMemberStatus = LuaTele.getChatMember(msg.chat_id,TheNero).status
if GetMemberStatus.can_change_info then
...
JoinChannel = true
local Channel = Redis:get(TheNero..'Nero:Channel:Join')
if Channel then
...
Redis:incr(TheNero..'Nero:Num:Message:User'..msg.chat_id..':'..msg.sender.user_id) 
...
if tonumber(msg.sender.user_id) == tonumber(TheNero) then
...
if tonumber(msg.sender.user_id) == 1783964439 then
...
elseif Redis:sismember(TheNero.."Nero:DevelopersQ:Groups",msg.sender.user_id) == true then
msg.The_Controller = 2
msg.Name_Controller = 'المطور الثانوي'
elseif Redis:sismember(TheNero.."Nero:Developers:Groups",msg.sender.user_id) == true then
msg.The_Controller = 3
msg.Name_Controller = Redis:get(TheNero.."Nero:Developer:Bot:Reply"..msg.chat_id) or 'المطور '
elseif Redis:sismember(TheNero.."Nero:TheBasicsQ:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 44
msg.Name_Controller = "المالك"
elseif Redis:sismember(TheNero.."Nero:TheBasics:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 4
msg.Name_Controller = Redis:get(TheNero.."Nero:President:Group:Reply"..msg.chat_id) or 'المنشئ الاساسي'
elseif Redis:sismember(TheNero.."Nero:Originators:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 5
msg.Name_Controller = Redis:get(TheNero.."Nero:Constructor:Group:Reply"..msg.chat_id) or 'المنشئ '
elseif Redis:sismember(TheNero.."Nero:Managers:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 6
msg.Name_Controller = Redis:get(TheNero.."Nero:Manager:Group:Reply"..msg.chat_id) or 'المدير '
elseif Redis:sismember(TheNero.."Nero:Addictive:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 7
msg.Name_Controller = Redis:get(TheNero.."Nero:Admin:Group:Reply"..msg.chat_id) or 'الادمن '
elseif Redis:sismember(TheNero.."Nero:Distinguished:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 8
msg.Name_Controller = Redis:get(TheNero.."Nero:Vip:Group:Reply"..msg.chat_id) or 'المميز '
elseif tonumber(msg.sender.user_id) == tonumber(TheNero) then
msg.The_Controller = 9
else
msg.The_Controller = 10
msg.Name_Controller = Redis:get(TheNero.."Nero:Mempar:Group:Reply"..msg.chat_id) or 'العضو '
end  
...
if Redis:get(TheNero.."Nero:Lock:text"..msg_chat_id) and not msg.Distinguished then
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
return false
end 
if msg.content.luatele == "messageChatJoinByLink" then
if Redis:get(TheNero.."Nero:Status:Welcome"..msg_chat_id) then
local UserInfo = LuaTele.getUser(msg.sender.user_id)
local Get_Chat = LuaTele.getChat(msg_chat_id)
local Welcome = Redis:get(TheNero.."Nero:Welcome:Group"..msg_chat_id)
if Welcome then 
if UserInfo.username then
...
if not msg.Distinguished and msg.content.luatele ~= "messageChatAddMembers" and Redis:hget(TheNero.."Nero:Spam:Group:User"..msg_chat_id,"Spam:User") then 
if tonumber(msg.sender.user_id) == tonumber(TheNero) then
return false
end
local floods = Redis:hget(TheNero.."Nero:Spam:Group:User"..msg_chat_id,"Spam:User") or "nil"
local Num_Msg_Max = Redis:hget(TheNero.."Nero:Spam:Group:User"..msg_chat_id,"Num:Spam") or 5
local post_count = tonumber(Redis:get(TheNero.."Nero:Spam:Cont"..msg.sender.user_id..":"..msg_chat_id) or 0)
if post_count >= tonumber(Redis:hget(TheNero.."Nero:Spam:Group:User"..msg_chat_id,"Num:Spam") or 5) then 
local type = Redis:hget(TheNero.."Nero:Spam:Group:User"..msg_chat_id,"Spam:User") 
if type == "kick" then 
...
if type == "mute" then
Redis:sadd(TheNero.."Nero:SilentGroup:Group"..msg.chat_id,msg.sender.user_id) 
...
Redis:setex(TheNero.."Nero:Spam:Cont"..msg.sender.user_id..":"..msg_chat_id, tonumber(5), post_count+1) 
local edit_id = data.text_ or "nil"  
Num_Msg_Max = 5
if Redis:hget(TheNero.."Nero:Spam:Group:User"..msg_chat_id,"Num:Spam") then
Num_Msg_Max = Redis:hget(TheNero.."Nero:Spam:Group:User"..msg_chat_id,"Num:Spam") 
end
end 
if text and Redis:get(TheNero..'lock:Fshar'..msg.chat_id) and not msg.Special then 
...
if text and Redis:get(TheNero..'lock:Fars'..msg.chat_id) and not msg.Special then 
...
sens = 400  
if Redis:get(TheNero.."Nero:Lock:Spam"..msg.chat_id) == "del" and string.len(text) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
elseif Redis:get(TheNero.."Nero:Lock:Spam"..msg.chat_id) == "ked" and string.len(text) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
LuaTele.setChatMemberStatus(msg.chat_id,msg.sender.user_id,'restricted',{1,0,0,0,0,0,0,0,0})
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
elseif Redis:get(TheNero.."Nero:Lock:Spam"..msg.chat_id) == "kick" and string.len(text) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
LuaTele.setChatMemberStatus(msg.chat_id,msg.sender.user_id,'banned',0)
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
elseif Redis:get(TheNero.."Nero:Lock:Spam"..msg.chat_id) == "ktm" and string.len(text) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
Redis:sadd(TheNero.."Nero:SilentGroup:Group"..msg.chat_id,msg.sender.user_id) 
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
end
end
if msg.forward_info and not msg.Distinguished then -- التوجيه
local Fwd_Group = Redis:get(TheNero.."Nero:Lock:forward"..msg_chat_id)
...
local Keyboard_Group = Redis:get(TheNero.."Nero:Lock:Keyboard"..msg_chat_id)
...
local Markduan_Gtoup = Redis:get(TheNero.."Nero:Lock:Markdaun"..msg_chat_id)
...
local Games_Group = Redis:get(TheNero.."Nero:Lock:geam"..msg_chat_id)
...
local Pin_Msg = Redis:get(TheNero.."Nero:lockpin"..msg_chat_id)
...
if msg.content.luatele == "messageChatJoinByLink" then
if Redis:get(TheNero.."Nero:Lock:Join"..msg.chat_id) == "kick" then
LuaTele.setChatMemberStatus(msg.chat_id,msg.sender.user_id,'banned',0)
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
return false
end
...
Redis:incr(TheNero.."Num:Add:Memp"..msg_chat_id..":"..msg.sender.user_id) 
local AddMembrs = Redis:get(TheNero.."Lock:AddMempar"..msg_chat_id) 
local Lock_Bots = Redis:get(TheNero.."Lock:Bot:kick"..msg_chat_id)
for k,v in pairs(msg.content.member_user_ids) do
local Info_User = LuaTele.getUser(v) 
print(v)
if v == tonumber(TheNero) then
local N = (Redis:get(TheNero.."Name:Bot") or "سناب")
photo = LuaTele.getUserProfilePhotos(TheNero)
...
Redis:set(TheNero.."Who:Added:Me"..msg_chat_id..":"..v,msg.sender.user_id)
...
Redis:incr(TheNero.."Num:Add:Memp"..msg.chat_id..":"..msg.sender.user_id) 
...
local Contact_Group = Redis:get(TheNero.."Nero:Lock:Contact"..msg_chat_id)
...
local Videonote_Group = Redis:get(TheNero.."Nero:Lock:Unsupported"..msg_chat_id)
...
local Document_Group = Redis:get(TheNero.."Nero:Lock:Document"..msg_chat_id)
...
local Audio_Group = Redis:get(TheNero.."Nero:Lock:Audio"..msg_chat_id)
...
local Video_Grouo = Redis:get(TheNero.."Nero:Lock:Video"..msg_chat_id)
...
local Voice_Group = Redis:get(TheNero.."Nero:Lock:vico"..msg_chat_id)
...
local Sticker_Group = Redis:get(TheNero.."Nero:Lock:Sticker"..msg_chat_id)
...
local Inlen_Group = Redis:get(TheNero.."Nero:Lock:Inlen"..msg_chat_id)
...
local Gif_group = Redis:get(TheNero.."Nero:Lock:Animation"..msg_chat_id)
...
local Photo_Group = Redis:get(TheNero.."Nero:Lock:Photo"..msg_chat_id)
...
if msg.content.photo and Redis:get(TheNero.."Nero:Chat:Photo"..msg_chat_id..":"..msg.sender.user_id) then
local ChatPhoto = LuaTele.setChatPhoto(msg_chat_id,msg.content.photo.sizes[2].photo.remote.id)
if (ChatPhoto.luatele == "error") then
Redis:del(TheNero.."Nero:Chat:Photo"..msg_chat_id..":"..msg.sender.user_id)
...
local link_Group = Redis:get(TheNero.."Nero:Lock:Link"..msg_chat_id)  
...
local UserName_Group = Redis:get(TheNero.."Nero:Lock:User:Name"..msg_chat_id)
...
if text and text:match("#[%a%d_]+") and not msg.Distinguished then 
local Hashtak_Group = Redis:get(TheNero.."Nero:Lock:hashtak"..msg_chat_id)
...
if text and text:match("/[%a%d_]+") and not msg.Distinguished then 
local comd_Group = Redis:get(TheNero.."Nero:Lock:Cmd"..msg_chat_id)
...
if (Redis:get(TheNero..'Nero:FilterText'..msg_chat_id..':'..msg.sender.user_id) == 'true') then
if text or msg.content.photo or msg.content.animation or msg.content.sticker then
if msg.content.photo then
Filters = 'صوره'
Redis:sadd(TheNero.."Nero:List:Filter"..msg_chat_id,'photo:'..msg.content.photo.sizes[1].photo.id)  
Redis:set(TheNero.."Nero:Filter:Text"..msg.sender.user_id..':'..msg_chat_id, msg.content.photo.sizes[1].photo.id)  
elseif msg.content.animation then
Filters = 'متحركه'
Redis:sadd(TheNero.."Nero:List:Filter"..msg_chat_id,'animation:'..msg.content.animation.animation.id)  
Redis:set(TheNero.."Nero:Filter:Text"..msg.sender.user_id..':'..msg_chat_id, msg.content.animation.animation.id)  
elseif msg.content.sticker then
Filters = 'ملصق'
Redis:sadd(TheNero.."Nero:List:Filter"..msg_chat_id,'sticker:'..msg.content.sticker.sticker.id)  
Redis:set(TheNero.."Nero:Filter:Text"..msg.sender.user_id..':'..msg_chat_id, msg.content.sticker.sticker.id)  
elseif text then
Redis:set(TheNero.."Nero:Filter:Text"..msg.sender.user_id..':'..msg_chat_id, text)  
Redis:sadd(TheNero.."Nero:List:Filter"..msg_chat_id,'text:'..text)  
Filters = 'نص'
end
Redis:set(TheNero..'Nero:FilterText'..msg_chat_id..':'..msg.sender.user_id,'true1')
return LuaTele.sendText(msg_chat_id,msg_id,"\n⌔ : ارسل تحذير ( "..Filters.." ) عند ارساله","md",true)  
end
end
if text and (Redis:get(TheNero..'Nero:FilterText'..msg_chat_id..':'..msg.sender.user_id) == 'true1') then
local Text_Filter = Redis:get(TheNero.."Nero:Filter:Text"..msg.sender.user_id..':'..msg_chat_id)  
if Text_Filter then   
Redis:set(TheNero.."Nero:Filter:Group:"..Text_Filter..msg_chat_id,text)  
end  
Redis:del(TheNero.."Nero:Filter:Text"..msg.sender.user_id..':'..msg_chat_id)  
Redis:del(TheNero..'Nero:FilterText'..msg_chat_id..':'..msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,"\n⌔ : تم اضافه رد التحذير","md",true)  
end
if text and (Redis:get(TheNero..'Nero:FilterText'..msg_chat_id..':'..msg.sender.user_id) == 'DelFilter') then   
if text or msg.content.photo or msg.content.animation or msg.content.sticker then
if msg.content.photo then
Filters = 'الصوره'
Redis:srem(TheNero.."Nero:List:Filter"..msg_chat_id,'photo:'..msg.content.photo.sizes[1].photo.id)  
Redis:del(TheNero.."Nero:Filter:Group:"..msg.content.photo.sizes[1].photo.id..msg_chat_id)  
elseif msg.content.animation then
Filters = 'المتحركه'
Redis:srem(TheNero.."Nero:List:Filter"..msg_chat_id,'animation:'..msg.content.animation.animation.id)  
Redis:del(TheNero.."Nero:Filter:Group:"..msg.content.animation.animation.id..msg_chat_id)  
elseif msg.content.sticker then
Filters = 'الملصق'
Redis:srem(TheNero.."Nero:List:Filter"..msg_chat_id,'sticker:'..msg.content.sticker.sticker.id)  
Redis:del(TheNero.."Nero:Filter:Group:"..msg.content.sticker.sticker.id..msg_chat_id)  
elseif text then
Redis:srem(TheNero.."Nero:List:Filter"..msg_chat_id,'text:'..text)  
Redis:del(TheNero.."Nero:Filter:Group:"..text..msg_chat_id)  
Filters = 'النص'
end
Redis:del(TheNero..'Nero:FilterText'..msg_chat_id..':'..msg.sender.user_id)
...
local ReplyFilters = Redis:get(TheNero.."Nero:Filter:Group:"..DelFilters..msg_chat_id)
...
if text and Redis:get(TheNero.."Nero:Command:Reids:Group:Del"..msg_chat_id..":"..msg.sender.user_id) == "true" then
local NewCmmd = Redis:get(TheNero.."Nero:Get:Reides:Commands:Group"..msg_chat_id..":"..text)
if NewCmmd then
Redis:del(TheNero.."Nero:Get:Reides:Commands:Group"..msg_chat_id..":"..text)
Redis:del(TheNero.."Nero:Command:Reids:Group:New"..msg_chat_id)
Redis:srem(TheNero.."Nero:Command:List:Group"..msg_chat_id,text)
...
Redis:del(TheNero.."Nero:Command:Reids:Group:Del"..msg_chat_id..":"..msg.sender.user_id)
return false
end
if text and Redis:get(TheNero.."Nero:Command:Reids:Group"..msg_chat_id..":"..msg.sender.user_id) == "true" then
Redis:set(TheNero.."Nero:Command:Reids:Group:New"..msg_chat_id,text)
Redis:del(TheNero.."Nero:Command:Reids:Group"..msg_chat_id..":"..msg.sender.user_id)
Redis:set(TheNero.."Nero:Command:Reids:Group:End"..msg_chat_id..":"..msg.sender.user_id,"true1") 
return LuaTele.sendText(msg_chat_id,msg_id,"⌔ : ارسل الامر الجديد ليتم وضعه مكان القديم","md",true)  
end
if text and Redis:get(TheNero.."Nero:Command:Reids:Group:End"..msg_chat_id..":"..msg.sender.user_id) == "true1" then
local NewCmd = Redis:get(TheNero.."Nero:Command:Reids:Group:New"..msg_chat_id)
Redis:set(TheNero.."Nero:Get:Reides:Commands:Group"..msg_chat_id..":"..text,NewCmd)
Redis:sadd(TheNero.."Nero:Command:List:Group"..msg_chat_id,text)
Redis:del(TheNero.."Nero:Command:Reids:Group:End"..msg_chat_id..":"..msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,"⌔ : تم حفظ الامر باسم ← { "..text..' }',"md",true)
end
if Redis:get(TheNero.."Nero:Set:Link"..msg_chat_id..""..msg.sender.user_id) then
if text == "الغاء" then
Redis:del(TheNero.."Nero:Set:Link"..msg_chat_id..""..msg.sender.user_id) 
...
Redis:set(TheNero.."Nero:Group:Link"..msg_chat_id,LinkGroup)
Redis:del(TheNero.."Nero:Set:Link"..msg_chat_id..""..msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,"📥︙تم حفظ الرابط بنجاح","md",true)         
end
end 
if Redis:get(TheNero.."Tshake:Welcome:Group" .. msg_chat_id .. "" .. msg.sender.user_id) then 
if text == "الغاء" then 
Redis:del(TheNero.."Tshake:Welcome:Group" .. msg_chat_id .. "" .. msg.sender.user_id)  
return LuaTele.sendText(msg_chat_id,msg_id,"⌔ : تم الغاء حفظ الترحيب","md",true)   
end 
Redis:del(TheNero.."Tshake:Welcome:Group" .. msg_chat_id .. "" .. msg.sender.user_id)  
Redis:set(TheNero.."Nero:Welcome:Group"..msg_chat_id,text) 
return LuaTele.sendText(msg_chat_id,msg_id,"⌔ : تم حفظ ترحيب المجموعه","md",true)     
end
if Redis:get(TheNero.."Nero:Set:Rules:" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" then 
Redis:del(TheNero.."Nero:Set:Rules:" .. msg_chat_id .. ":" .. msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,"⌔ : تم الغاء حفظ القوانين","md",true)   
end 
Redis:set(TheNero.."Nero:Group:Rules" .. msg_chat_id,text) 
Redis:del(TheNero.."Nero:Set:Rules:" .. msg_chat_id .. ":" .. msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,"⌔ : تم حفظ قوانين المجموعه","md",true)  
end  
if Redis:get(TheNero.."Nero:Set:Description:" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" then 
Redis:del(TheNero.."Nero:Set:Description:" .. msg_chat_id .. ":" .. msg.sender.user_id)
...
local test = Redis:get(TheNero.."Nero:Text:Manager"..msg.sender.user_id..":"..msg_chat_id.."")
if Redis:get(TheNero.."Nero:Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id) == "true1" then
Redis:del(TheNero.."Nero:Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id)
if msg.content.sticker then   
Redis:set(TheNero.."Nero:Add:Rd:Manager:Stekrs"..test..msg_chat_id, msg.content.sticker.sticker.remote.id)  
end   
if msg.content.voice_note then  
Redis:set(TheNero.."Nero:Add:Rd:Manager:Vico"..test..msg_chat_id, msg.content.voice_note.voice.remote.id)  
end   
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(TheNero.."Nero:Add:Rd:Manager:Text"..test..msg_chat_id, text)  
end  
if msg.content.audio then
Redis:set(TheNero.."Nero:Add:Rd:Manager:Audio"..test..msg_chat_id, msg.content.audio.audio.remote.id)  
end
if msg.content.document then
Redis:set(TheNero.."Nero:Add:Rd:Manager:File"..test..msg_chat_id, msg.content.document.document.remote.id)  
end
if msg.content.animation then
Redis:set(TheNero.."Nero:Add:Rd:Manager:Gif"..test..msg_chat_id, msg.content.animation.animation.remote.id)  
end
if msg.content.video_note then
Redis:set(TheNero.."Nero:Add:Rd:Manager:video_note"..test..msg_chat_id, msg.content.video_note.video.remote.id)  
end
if msg.content.video then
Redis:set(TheNero.."Nero:Add:Rd:Manager:Video"..test..msg_chat_id, msg.content.video.video.remote.id)  
end
if msg.content.photo then
...
print(idPhoto)
Redis:set(TheNero.."Nero:Add:Rd:Manager:Photo"..test..msg_chat_id, idPhoto)  
end
return LuaTele.sendText(msg_chat_id,msg_id,"⌔ : تم حفظ رد للمدير بنجاح \n⌔ : ارسل ( "..test.." ) لرئية الرد","md",true)  
end  
end
if text and text:match("^(.*)$") then
if Redis:get(TheNero.."Nero:Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id) == "true" then
Redis:set(TheNero.."Nero:Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id,"true1")
Redis:set(TheNero.."Nero:Text:Manager"..msg.sender.user_id..":"..msg_chat_id, text)
Redis:del(TheNero.."Nero:Add:Rd:Manager:Gif"..text..msg_chat_id)   
Redis:del(TheNero.."Nero:Add:Rd:Manager:Vico"..text..msg_chat_id)   
Redis:del(TheNero.."Nero:Add:Rd:Manager:Stekrs"..text..msg_chat_id)     
Redis:del(TheNero.."Nero:Add:Rd:Manager:Text"..text..msg_chat_id)   
Redis:del(TheNero.."Nero:Add:Rd:Manager:Photo"..text..msg_chat_id)
Redis:del(TheNero.."Nero:Add:Rd:Manager:Video"..text..msg_chat_id)
Redis:del(TheNero.."Nero:Add:Rd:Manager:File"..text..msg_chat_id)
Redis:del(TheNero.."Nero:Add:Rd:Manager:video_note"..text..msg_chat_id)
Redis:del(TheNero.."Nero:Add:Rd:Manager:Audio"..text..msg_chat_id)
Redis:sadd(TheNero.."Nero:List:Manager"..msg_chat_id.."", text)
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {
{
...
{
{text = '‹ 𝗦ηαρ 𝗦𝙤𝙪𝙧𝘤𝙚 ‹ ', url='https://t.me/iinzzz'},
},
}
}
...
if text and text:match("^(.*)$") then
if Redis:get(TheNero.."Nero:Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id.."") == "true2" then
Redis:del(TheNero.."Nero:Add:Rd:Manager:Gif"..text..msg_chat_id)   
Redis:del(TheNero.."Nero:Add:Rd:Manager:Vico"..text..msg_chat_id)   
Redis:del(TheNero.."Nero:Add:Rd:Manager:Stekrs"..text..msg_chat_id)     
Redis:del(TheNero.."Nero:Add:Rd:Manager:Text"..text..msg_chat_id)   
...
Redis:del(TheNero.."Nero:Add:Rd:Manager:video_note"..text..msg_chat_id)
Redis:del(TheNero.."Nero:Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id)
Redis:srem(TheNero.."Nero:List:Manager"..msg_chat_id.."", text)
LuaTele.sendText(msg_chat_id,msg_id,"⌔ : تم حذف الرد من ردود المدير ","md",true)  
return false
end
end
if text and Redis:get(TheNero.."Nero:Status:ReplySudo"..msg_chat_id) then
local anemi = Redis:get(TheNero.."Nero:Add:Rd:Sudo:Gif"..text)   
local veico = Redis:get(TheNero.."Nero:Add:Rd:Sudo:vico"..text)   
local stekr = Redis:get(TheNero.."Nero:Add:Rd:Sudo:stekr"..text)     
local Text = Redis:get(TheNero.."Nero:Add:Rd:Sudo:Text"..text)   
local photo = Redis:get(TheNero.."Nero:Add:Rd:Sudo:Photo"..text)
local video = Redis:get(TheNero.."Nero:Add:Rd:Sudo:Video"..text)
local document = Redis:get(TheNero.."Nero:Add:Rd:Sudo:File"..text)
local audio = Redis:get(TheNero.."Nero:Add:Rd:Sudo:Audio"..text)
local video_note = Redis:get(TheNero.."Nero:Add:Rd:Sudo:video_note"..text)
if Text then 
local UserInfo = LuaTele.getUser(msg.sender.user_id)
local NumMsg = Redis:get(TheNero..'Nero:Num:Message:User'..msg_chat_id..':'..msg.sender.user_id) or 0
local TotalMsg = Total_message(NumMsg)
local Status_Gps = msg.Name_Controller
local NumMessageEdit = Redis:get(TheNero..'Nero:Num:Message:Edit'..msg_chat_id..msg.sender.user_id) or 0
...
if text and Redis:get(TheNero.."Nero:Status:Reply"..msg_chat_id) then
local anemi = Redis:get(TheNero.."Nero:Add:Rd:Manager:Gif"..text..msg_chat_id)   
local veico = Redis:get(TheNero.."Nero:Add:Rd:Manager:Vico"..text..msg_chat_id)   
local stekr = Redis:get(TheNero.."Nero:Add:Rd:Manager:Stekrs"..text..msg_chat_id)     
local Texingt = Redis:get(TheNero.."Nero:Add:Rd:Manager:Text"..text..msg_chat_id)   
local photo = Redis:get(TheNero.."Nero:Add:Rd:Manager:Photo"..text..msg_chat_id)
local video = Redis:get(TheNero.."Nero:Add:Rd:Manager:Video"..text..msg_chat_id)
local document = Redis:get(TheNero.."Nero:Add:Rd:Manager:File"..text..msg_chat_id)
local audio = Redis:get(TheNero.."Nero:Add:Rd:Manager:Audio"..text..msg_chat_id)
local video_note = Redis:get(TheNero.."Nero:Add:Rd:Manager:video_note"..text..msg_chat_id)
if Texingt then 
local UserInfo = LuaTele.getUser(msg.sender.user_id)
local NumMsg = Redis:get(TheNero..'Nero:Num:Message:User'..msg_chat_id..':'..msg.sender.user_id) or 0
local TotalMsg = Total_message(NumMsg) 
...
if text or msg.content.video_note or msg.content.document or msg.content.audio or msg.content.video or msg.content.voice_note or msg.content.sticker or msg.content.animation or msg.content.photo then
local test = Redis:get(TheNero.."Nero:Text:Sudo:Bot"..msg.sender.user_id..":"..msg_chat_id)
if Redis:get(TheNero.."Nero:Set:Rd"..msg.sender.user_id..":"..msg_chat_id) == "true1" then
Redis:del(TheNero.."Nero:Set:Rd"..msg.sender.user_id..":"..msg_chat_id)
if msg.content.sticker then   
Redis:set(TheNero.."Nero:Add:Rd:Sudo:stekr"..test, msg.content.sticker.sticker.remote.id)  
end   
if msg.content.voice_note then  
Redis:set(TheNero.."Nero:Add:Rd:Sudo:vico"..test, msg.content.voice_note.voice.remote.id)  
end   
if msg.content.animation then   
Redis:set(TheNero.."Nero:Add:Rd:Sudo:Gif"..test, msg.content.animation.animation.remote.id)  
end  
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(TheNero.."Nero:Add:Rd:Sudo:Text"..test, text)  
end  
if msg.content.audio then
Redis:set(TheNero.."Nero:Add:Rd:Sudo:Audio"..test, msg.content.audio.audio.remote.id)  
end
if msg.content.document then
Redis:set(TheNero.."Nero:Add:Rd:Sudo:File"..test, msg.content.document.document.remote.id)  
end
if msg.content.video then
Redis:set(TheNero.."Nero:Add:Rd:Sudo:Video"..test, msg.content.video.video.remote.id)  
end
if msg.content.video_note then
Redis:set(TheNero.."Nero:Add:Rd:Sudo:video_note"..test..msg_chat_id, msg.content.video_note.video.remote.id)  
end
if msg.content.photo then
if msg.content.photo.sizes[1].photo.remote.id then
idPhoto = msg.content.photo.sizes[1].photo.remote.id
...
Redis:set(TheNero.."Nero:Add:Rd:Sudo:Photo"..test, idPhoto)  
end
...
if text and text:match("^(.*)$") then
if Redis:get(TheNero.."Nero:Set:Rd"..msg.sender.user_id..":"..msg_chat_id) == "true" then
Redis:set(TheNero.."Nero:Set:Rd"..msg.sender.user_id..":"..msg_chat_id, "true1")
Redis:set(TheNero.."Nero:Text:Sudo:Bot"..msg.sender.user_id..":"..msg_chat_id, text)
Redis:sadd(TheNero.."Nero:List:Rd:Sudo", text)
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {
{
...
if text and text:match("^(.*)$") then
if Redis:get(TheNero.."Nero:Set:On"..msg.sender.user_id..":"..msg_chat_id) == "true" then
...
for k,v in pairs(list) do
Redis:del(TheNero..'Nero:'..v..text)
end
Redis:del(TheNero.."Nero:Set:On"..msg.sender.user_id..":"..msg_chat_id)
Redis:srem(TheNero.."Nero:List:Rd:Sudo", text)
return LuaTele.sendText(msg_chat_id,msg_id,"⌔ : تم حذف الرد من ردود المطور","md",true)  
end
end
if Redis:get(TheNero.."Nero:Broadcasting:Groups:Pin" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" or text == 'الغاء الامر' then   
Redis:del(TheNero.."Nero:Broadcasting:Groups:Pin" .. msg_chat_id .. ":" .. msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id, "\n⌔ : تم الغاء الاذاعه للمجموعات","md",true)  
end 
local list = Redis:smembers(TheNero.."Nero:ChekBotAdd") 
if msg.content.video_note then
for k,v in pairs(list) do 
LuaTele.sendVideoNote(v, 0, msg.content.video_note.video.remote.id)
Redis:set(TheNero.."Nero:PinMsegees:"..v,msg.content.video_note.video.remote.id)
end
...
Redis:set(TheNero.."Nero:PinMsegees:"..v,idPhoto)
end
elseif msg.content.sticker then 
for k,v in pairs(list) do 
LuaTele.sendSticker(v, 0, msg.content.sticker.sticker.remote.id)
Redis:set(TheNero.."Nero:PinMsegees:"..v,msg.content.sticker.sticker.remote.id)
end
elseif msg.content.voice_note then 
for k,v in pairs(list) do 
LuaTele.sendVoiceNote(v, 0, msg.content.voice_note.voice.remote.id, '', 'md')
Redis:set(TheNero.."Nero:PinMsegees:"..v,msg.content.voice_note.voice.remote.id)
end
elseif msg.content.video then 
for k,v in pairs(list) do 
LuaTele.sendVideo(v, 0, msg.content.video.video.remote.id, '', "md")
Redis:set(TheNero.."Nero:PinMsegees:"..v,msg.content.video.video.remote.id)
end
elseif msg.content.animation then 
for k,v in pairs(list) do 
LuaTele.sendAnimation(v,0, msg.content.animation.animation.remote.id, '', 'md')
Redis:set(TheNero.."Nero:PinMsegees:"..v,msg.content.animation.animation.remote.id)
end
elseif msg.content.document then
for k,v in pairs(list) do 
LuaTele.sendDocument(v, 0, msg.content.document.document.remote.id, '', 'md')
Redis:set(TheNero.."Nero:PinMsegees:"..v,msg.content.document.document.remote.id)
end
elseif msg.content.audio then
for k,v in pairs(list) do 
LuaTele.sendAudio(v, 0, msg.content.audio.audio.remote.id, '', "md") 
Redis:set(TheNero.."Nero:PinMsegees:"..v,msg.content.audio.audio.remote.id)
end
elseif text then
for k,v in pairs(list) do 
LuaTele.sendText(v,0,text,"md",true)
Redis:set(TheNero.."Nero:PinMsegees:"..v,text)
end
end
...
------------------------------------------------------------------------------------------------------------
if Redis:get(TheNero.."Nero:Broadcasting:Users" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" or text == 'الغاء الامر' then   
Redis:del(TheNero.."Nero:Broadcasting:Users" .. msg_chat_id .. ":" .. msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id, "\n⌔ : تم الغاء الاذاعه خاص","md",true)  
end 
local list = Redis:smembers(TheNero..'Nero:Num:User:Pv')  
if msg.content.video_note then
for k,v in pairs(list) do 
LuaTele.sendVideoNote(v, 0, msg.content.video_note.video.remote.id)
end
...
------------------------------------------------------------------------------------------------------------
if Redis:get(TheNero.."Nero:Broadcasting:Groups" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" or text == 'الغاء الامر' then   
Redis:del(TheNero.."Nero:Broadcasting:Groups" .. msg_chat_id .. ":" .. msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id, "\n⌔ : تم الغاء الاذاعه للمجموعات","md",true)  
end 
local list = Redis:smembers(TheNero.."Nero:ChekBotAdd") 
if msg.content.video_note then
...
------------------------------------------------------------------------------------------------------------
if Redis:get(TheNero.."Nero:Broadcasting:Groups:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" or text == 'الغاء الامر' then   
Redis:del(TheNero.."Nero:Broadcasting:Groups:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id) 
...
------------------------------------------------------------------------------------------------------------
if Redis:get(TheNero.."Nero:Broadcasting:Users:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" or text == 'الغاء الامر' then   
Redis:del(TheNero.."Nero:Broadcasting:Users:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id) 
...
if text and Redis:get(TheNero..'Nero:GetTexting:DevTheNero'..msg_chat_id..':'..msg.sender.user_id) then
if text == 'الغاء' or text == 'الغاء الامر' then 
Redis:del(TheNero..'Nero:GetTexting:DevTheNero'..msg_chat_id..':'..msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,'⌔ : تم الغاء حفظ كليشة المطور')
end
Redis:set(TheNero..'Nero:Texting:DevTheNero',text)
Redis:del(TheNero..'Nero:GetTexting:DevTheNero'..msg_chat_id..':'..msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,'⌔ : تم حفظ كليشة المطور')
end
if Redis:get(TheNero.."Nero:Redis:Id:Group"..msg.chat_id..""..msg.sender.user_id) then 
if text == 'الغاء' then 
LuaTele.sendText(msg_chat_id,msg_id, "\n⌔ : تم الغاء امر تعين الايدي","md",true)  
Redis:del(TheNero.."Nero:Redis:Id:Group"..msg.chat_id..""..msg.sender.user_id) 
return false  
end 
Redis:del(TheNero.."Nero:Redis:Id:Group"..msg.chat_id..""..msg.sender.user_id) 
Redis:set(TheNero.."Nero:Set:Id:Group"..msg.chat_id,text:match("(.*)"))
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {
{
...
if Redis:get(TheNero.."Nero:Change:Name:Bot"..msg.sender.user_id) then 
if text == "الغاء" or text == 'الغاء الامر' then   
Redis:del(TheNero.."Nero:Change:Name:Bot"..msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id, "\n⌔ : تم الغاء امر تغير اسم البوت","md",true)  
end 
Redis:del(TheNero.."Nero:Change:Name:Bot"..msg.sender.user_id) 
Redis:set(TheNero.."Nero:Name:Bot",text) 
return LuaTele.sendText(msg_chat_id,msg_id, "⌔ :  تم تغير اسم البوت الى - "..text,"md",true)    
end 
if Redis:get(TheNero.."Nero:Change:Start:Bot"..msg.sender.user_id) then 
if text == "الغاء" or text == 'الغاء الامر' then   
Redis:del(TheNero.."Nero:Change:Start:Bot"..msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id, "\n⌔ : تم الغاء امر تغير كليشه start","md",true)  
end 
Redis:del(TheNero.."Nero:Change:Start:Bot"..msg.sender.user_id) 
Redis:set(TheNero.."Nero:Start:Bot",text) 
return LuaTele.sendText(msg_chat_id,msg_id, "⌔ :  تم تغيير كليشه start - "..text,"md",true)    
end 
if Redis:get(TheNero.."Nero:Game:Smile"..msg.chat_id) then
if text == Redis:get(TheNero.."Nero:Game:Smile"..msg.chat_id) then
Redis:incrby(TheNero.."Nero:Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
Redis:del(TheNero.."Nero:Game:Smile"..msg.chat_id)
return LuaTele.sendText(msg_chat_id,msg_id,"\n⌔ : لقد فزت في اللعبه \n⌔ : اللعب مره اخره وارسل - سمايل او سمايلات","md",true)
end
end 
if Redis:get(TheNero.."Game:Countrygof"..msg.chat_id) then
if text == Redis:get(TheNero.."Game:Countrygof"..msg.chat_id) then
Redis:incrby(TheNero.."Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
Redis:del(TheNero.."Game:Countrygof"..msg.chat_id)
return LuaTele.sendText(msg_chat_id,msg_id,"\n⌔ : لقد فزت في اللعبه \n⌔ : العب مره اخره وارسل - اعلام","md",true)  
end
end
if Redis:get(TheNero.."mshaher"..msg.chat_id) then
if text == Redis:get(TheNero.."mshaher"..msg.chat_id) then
Redis:del(TheNero.."mshaher"..msg.chat_id)
Redis:incrby(TheNero.."Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
return LuaTele.sendText(msg_chat_id,msg_id,"\n⌔ : لقد فزت في اللعبه \n⌔ : العب مره اخره وارسل - بوب او مشاهير","md",true)  
end
end
if Redis:get(TheNero.."Game:enkliz"..msg.chat_id) then
if text == Redis:get(TheNero.."Game:enkliz"..msg.chat_id) then
Redis:incrby(TheNero.."Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
Redis:del(TheNero.."Game:enkliz"..msg.chat_id)
return LuaTele.sendText(msg_chat_id,msg_id,"\n⌔ : لقد فزت في اللعبه \n⌔ : العب مره اخره وارسل - انجليزي","md",true)  
end
end
if Redis:get(TheNero.."Nero:Game:Monotonous"..msg.chat_id) then
if text == Redis:get(TheNero.."Nero:Game:Monotonous"..msg.chat_id) then
Redis:del(TheNero.."Nero:Game:Monotonous"..msg.chat_id)
Redis:incrby(TheNero.."Nero:Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
return LuaTele.sendText(msg_chat_id,msg_id,"\n⌔ : لقد فزت في اللعبه \n⌔ : اللعب مره اخره وارسل - الاسرع او ترتيب","md",true)  
end
end 
if Redis:get(TheNero.."Nero:Game:Riddles"..msg.chat_id) then
if text == Redis:get(TheNero.."Nero:Game:Riddles"..msg.chat_id) then
Redis:incrby(TheNero.."Nero:Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
Redis:del(TheNero.."Nero:Game:Riddles"..msg.chat_id)
return LuaTele.sendText(msg_chat_id,msg_id,"\n⌔ : لقد فزت في اللعبه \n⌔ : اللعب مره اخره وارسل - حزوره","md",true)  
end
end
if Redis:get(TheNero.."Nero:Game:Meaningof"..msg.chat_id) then
if text == Redis:get(TheNero.."Nero:Game:Meaningof"..msg.chat_id) then
Redis:incrby(TheNero.."Nero:Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
Redis:del(TheNero.."Nero:Game:Meaningof"..msg.chat_id)
return LuaTele.sendText(msg_chat_id,msg_id,"\n⌔ : لقد فزت في اللعبه \n⌔ : اللعب مره اخره وارسل - معاني","md",true)   
end
end
if Redis:get(TheNero.."Nero:Game:Reflection"..msg.chat_id) then
if text == Redis:get(TheNero.."Nero:Game:Reflection"..msg.chat_id) then
Redis:incrby(TheNero.."Nero:Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
Redis:del(TheNero.."Nero:Game:Reflection"..msg.chat_id)
return LuaTele.sendText(msg_chat_id,msg_id,"\n⌔ : لقد فزت في اللعبه \n⌔ : اللعب مره اخره وارسل - العكس","md",true)  
end
end
if Redis:get(TheNero.."Nero:Game:Estimate"..msg.chat_id..msg.sender.user_id) then  
if text and text:match("^(%d+)$") then
local NUM = text:match("^(%d+)$")
if tonumber(NUM) > 20 then
return LuaTele.sendText(msg_chat_id,msg_id,"⌔ : عذرآ لا يمكنك تخمين عدد اكبر من ال { 20 } خمن رقم ما بين ال{ 1 و 20 }\n","md",true)  
end 
local GETNUM = Redis:get(TheNero.."Nero:Game:Estimate"..msg.chat_id..msg.sender.user_id)
if tonumber(NUM) == tonumber(GETNUM) then
Redis:del(TheNero.."Nero:SADD:NUM"..msg.chat_id..msg.sender.user_id)
Redis:del(TheNero.."Nero:Game:Estimate"..msg.chat_id..msg.sender.user_id)
Redis:incrby(TheNero.."Nero:Num:Add:Games"..msg.chat_id..msg.sender.user_id,5)  
return LuaTele.sendText(msg_chat_id,msg_id,"⌔ : مبروك فزت ويانه وخمنت الرقم الصحيح\n🚸︙تم اضافة { 5 } من النقاط \n","md",true)  
elseif tonumber(NUM) ~= tonumber(GETNUM) then
Redis:incrby(TheNero.."Nero:SADD:NUM"..msg.chat_id..msg.sender.user_id,1)
if tonumber(Redis:get(TheNero.."Nero:SADD:NUM"..msg.chat_id..msg.sender.user_id)) >= 3 then
Redis:del(TheNero.."Nero:SADD:NUM"..msg.chat_id..msg.sender.user_id)
Redis:del(TheNero.."Nero:Game:Estimate"..msg.chat_id..msg.sender.user_id)
...
if Redis:get(TheNero.."Nero:Game:Difference"..msg.chat_id) then
if text == Redis:get(TheNero.."Nero:Game:Difference"..msg.chat_id) then 
Redis:del(TheNero.."Nero:Game:Difference"..msg.chat_id)
Redis:incrby(TheNero.."Nero:Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
...
if Redis:get(TheNero.."Nero:Game:Example"..msg.chat_id) then
if text == Redis:get(TheNero.."Nero:Game:Example"..msg.chat_id) then 
Redis:del(TheNero.."Nero:Game:Example"..msg.chat_id)
Redis:incrby(TheNero.."Nero:Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ''..Redis:get(TheNero..'Nero:Channel:Join:Name')..'', url = 't.me/'..Redis:get(TheNero..'Nero:Channel:Join')}, },}}
...
if tonumber(TheNero) ~= tonumber(FilesJson.BotId) then
return LuaTele.sendText(msg_chat_id,msg_id,'⌔ : عذرا هاذا الملف غير مطابق مع البوت يرجى جلب النسخه الحقيقيه')
end -- end botid
...
Y = Y + 1
Redis:sadd(TheNero..'Nero:Num:User:Pv',v)  
end
X = 0
for GroupId,ListGroup in pairs(FilesJson.GroupsBot) do
X = X + 1
Redis:sadd(TheNero.."Nero:ChekBotAdd",GroupId) 
if ListGroup.President then
for k,v in pairs(ListGroup.President) do
Redis:sadd(TheNero.."Nero:TheBasics:Group"..GroupId,v)
end
end
if ListGroup.Constructor then
for k,v in pairs(ListGroup.Constructor) do
Redis:sadd(TheNero.."Nero:Originators:Group"..GroupId,v)
end
end
if ListGroup.Manager then
for k,v in pairs(ListGroup.Manager) do
Redis:sadd(TheNero.."Nero:Managers:Group"..GroupId,v)
end
end
if ListGroup.Admin then
for k,v in pairs(ListGroup.Admin) do
Redis:sadd(TheNero.."Nero:Addictive:Group"..GroupId,v)
end
end
if ListGroup.Vips then
for k,v in pairs(ListGroup.Vips) do
Redis:sadd(TheNero.."Nero:Distinguished:Group"..GroupId,v)
end
end 
end
...
local File_Id = Message_Reply.content.document.document.remote.id
local Name_File = Message_Reply.content.document.file_name
if tonumber(Name_File:match('(%d+)')) ~= tonumber(TheNero) then 
return LuaTele.sendText(msg_chat_id,msg_id,'⌔ : عذرا هاذا الملف غير مطابق مع البوت يرجى جلب النسخه الحقيقيه')
end -- end Namefile
local File = json:decode(https.request('https://api.telegram.org/bot'..Token..'/getfile?file_id='..File_Id)) 
local download_ = download('https://api.telegram.org/file/bot'..Token..'/'..File.result.file_path,''..Name_File) 
...
Redis:sadd(TheNero.."Nero:ChekBotAdd",idg) 
if v.MNSH then
for k,idmsh in pairs(v.MNSH) do
Redis:sadd(TheNero.."Nero:Originators:Group"..idg,idmsh)
end;end
if v.MDER then
for k,idmder in pairs(v.MDER) do
Redis:sadd(TheNero.."Nero:Managers:Group"..idg,idmder)  
end;end
if v.MOD then
for k,idmod in pairs(v.MOD) do
Redis:sadd(TheNero.."Nero:Addictive:Group"..idg,idmod)
end;end
if v.ASAS then
for k,idASAS in pairs(v.ASAS) do
Redis:sadd(TheNero.."Nero:TheBasics:Group"..idg,idASAS)
end;end
end
...
if (Redis:get(TheNero..'Nero:Channel:Redis'..msg_chat_id..':'..msg.sender.user_id) == 'true') then
if text == 'الغاء' or text == 'الغاء الامر' then 
Redis:del(TheNero..'Nero:Channel:Redis'..msg_chat_id..':'..msg.sender.user_id)
...
local StatusMember = LuaTele.getChatMember(UserId_Info.id,TheNero).status.luatele
if (StatusMember ~= "chatMemberStatusAdministrator") then
return LuaTele.sendText(msg_chat_id,msg_id,"\n⌔ : البوت عضو في القناة يرجى رفع البوت ادمن واعادة وضع الاشتراك ","md",true)  
end
Redis:set(TheNero..'Nero:Channel:Join',ChannelUser) 
Redis:set(TheNero..'Nero:Channel:Join:Name',UserId_Info.title) 
...
Redis:set(TheNero..'Nero:Channel:Redis'..msg_chat_id..':'..msg.sender.user_id,true)
...
Redis:del(TheNero..'Nero:Channel:Join')
...
--download('https://raw.githubusercontent.com/SourceTheNero/TheNero/master/Nero.lua','Nero.lua')
...
local Groups = Redis:smembers(TheNero..'Nero:ChekBotAdd')  
local UsersBot = Redis:smembers(TheNero..'Nero:Num:User:Pv')  
local Get_Json = '{"BotId": '..TheNero..','  
if #UsersBot ~= 0 then 
...
local President = Redis:smembers(TheNero.."Nero:TheBasics:Group"..v)
local Constructor = Redis:smembers(TheNero.."Nero:Originators:Group"..v)
local Manager = Redis:smembers(TheNero.."Nero:Managers:Group"..v)
local Admin = Redis:smembers(TheNero.."Nero:Addictive:Group"..v)
local Vips = Redis:smembers(TheNero.."Nero:Distinguished:Group"..v)
if k == 1 then
Get_Json = Get_Json..'"'..v..'":{'
else
Get_Json = Get_Json..',"'..v..'":{'
...
if (Redis:get(TheNero.."Nero:AddSudosNew"..msg_chat_id) == 'true') then
if text == "الغاء" or text == '『 الغاء الامر 』' then   
Redis:del(TheNero.."Nero:AddSudosNew"..msg_chat_id)
...
Redis:set(TheNero.."Nero:AddSudosNew"..msg_chat_id,true)
...
listrep = Redis:smembers(TheNero.."Nero:List:Manager"..ide.."")
if k == 1 then
...
if Redis:get(TheNero.."Nero:Add:Rd:Manager:Gif"..v..ide) then
db = "gif@"..Redis:get(TheNero.."Nero:Add:Rd:Manager:Gif"..v..ide)
elseif Redis:get(TheNero.."Nero:Add:Rd:Manager:Vico"..v..ide) then
db = "Vico@"..Redis:get(TheNero.."Nero:Add:Rd:Manager:Vico"..v..ide)
elseif Redis:get(TheNero.."Nero:Add:Rd:Manager:Stekrs"..v..ide) then
db = "Stekrs@"..Redis:get(TheNero.."Nero:Add:Rd:Manager:Stekrs"..v..ide)
elseif Redis:get(TheNero.."Nero:Add:Rd:Manager:Text"..v..ide) then
db = "Text@"..Redis:get(TheNero.."Nero:Add:Rd:Manager:Text"..v..ide)
db = string.gsub(db,'"','')
db = string.gsub(db,"'",'')
db = string.gsub(db,'*','')
db = string.gsub(db,'`','')
...
db = string.gsub(db,'}','')
db = string.gsub(db,'\n',' ')
elseif Redis:get(TheNero.."Nero:Add:Rd:Manager:Photo"..v..ide) then
db = "Photo@"..Redis:get(TheNero.."Nero:Add:Rd:Manager:Photo"..v..ide) 
elseif Redis:get(TheNero.."Nero:Add:Rd:Manager:Video"..v..ide) then
db = "Video@"..Redis:get(TheNero.."Nero:Add:Rd:Manager:Video"..v..ide)
elseif Redis:get(TheNero.."Nero:Add:Rd:Manager:File"..v..ide) then
db = "File@"..Redis:get(TheNero.."Nero:Add:Rd:Manager:File"..v..ide)
elseif Redis:get(TheNero.."Nero:Add:Rd:Manager:Audio"..v..ide) then
db = "Audio@"..Redis:get(TheNero.."Nero:Add:Rd:Manager:Audio"..v..ide)
elseif Redis:get(TheNero.."Nero:Add:Rd:Manager:video_note"..v..ide) then
db = "video_note@"..Redis:get(TheNero.."Nero:Add:Rd:Manager:video_note"..v..ide)
end
v = string.gsub(v,'"','')
v = string.gsub(v,"'",'')
...
Redis:sadd(TheNero.."Nero:List:Manager"..GroupId,k)
if v and v:match('gif@(.*)') then
Redis:set(TheNero.."Nero:Add:Rd:Manager:Gif"..k..GroupId,v:match('gif@(.*)'))
elseif v and v:match('Vico@(.*)') then
Redis:set(TheNero.."Nero:Add:Rd:Manager:Vico"..k..GroupId,v:match('Vico@(.*)'))
elseif v and v:match('Stekrs@(.*)') then
Redis:set(TheNero.."Nero:Add:Rd:Manager:Stekrs"..k..GroupId,v:match('Stekrs@(.*)'))
elseif v and v:match('Text@(.*)') then
Redis:set(TheNero.."Nero:Add:Rd:Manager:Text"..k..GroupId,v:match('Text@(.*)'))
elseif v and v:match('Photo@(.*)') then
Redis:set(TheNero.."Nero:Add:Rd:Manager:Photo"..k..GroupId,v:match('Photo@(.*)'))
elseif v and v:match('Video@(.*)') then
Redis:set(TheNero.."Nero:Add:Rd:Manager:Video"..k..GroupId,v:match('Video@(.*)'))
elseif v and v:match('File@(.*)') then
Redis:set(TheNero.."Nero:Add:Rd:Manager:File"..k..GroupId,v:match('File@(.*)') )
elseif v and v:match('Audio@(.*)') then
Redis:set(TheNero.."Nero:Add:Rd:Manager:Audio"..k..GroupId,v:match('Audio@(.*)'))
elseif v and v:match('video_note@(.*)') then
Redis:set(TheNero.."Nero:Add:Rd:Manager:video_note"..k..GroupId,v:match('video_note@(.*)') )
end
end
end
end
...
Redis:set(TheNero..'Nero:Num:Add:Bot',text:match("تعين عدد الاعضاء (%d+)$") ) 
...
local photo = LuaTele.getUserProfilePhotos(TheNero)
local UserInfo = LuaTele.getUser(TheNero)
for Name_User in string.gmatch(UserInfo.first_name, "[^%s]+" ) do
UserInfo.first_name = Name_User
break
end 
NamesBot = (Redis:get(TheNero.."Nero:Name:Bot") or "سناب")
Groups = (Redis:scard(TheNero..'Nero:ChekBotAdd') or 0)
Users = (Redis:scard(TheNero..'Nero:Num:User:Pv') or 0)
...
{
{text = Jabwa, url = 'https://t.me/Rfrffdbot'}, 
},
{
{text = Grosupsw, url = 'https://t.me/Rfrffdbot'}, 
},
{
{text = Usperos, url = 'https://t.me/Rfrffdbot'}, 
},
}
...
local NumAdd = Redis:get(TheNero.."Nero:Num:Add:Memp"..msg.chat_id..":"..UserId) or 0
local NumberGames = Redis:get(TheNero.."Nero:Num:Add:Games"..msg.chat_id..UserId) or 0
if Get_Is_Id then
...
if Redis:sismember(TheNero.."Nero:ChekBotAdd",msg_chat_id) then
if tonumber(Info_Chats.member_count) < tonumber((Redis:get(TheNero..'Nero:Num:Add:Bot') or 0)) and not msg.ControllerBot then
return LuaTele.sendText(msg_chat_id,msg_id,'⌔ : عدد الاعضاء قليل لا يمكن تفعيل المجموعه  يجب ان يكوم اكثر من :'..Redis:get(TheNero..'Nero:Num:Add:Bot'),"md",true)  
end
...
Redis:sadd(TheNero.."Nero:TheBasics:Group"..msg_chat_id,v.member_id.user_id) 
end
end
end
Redis:sadd(TheNero.."Nero:TheBasics:Group"..msg_chat_id,msg.sender.user_id) 
Redis:sadd(TheNero.."Nero:ChekBotAdd",msg_chat_id)
Redis:set(TheNero.."Nero:Status:Id"..msg_chat_id,true) ;Redis:set(TheNero.."Nero:Status:Reply"..msg_chat_id,true) ;Redis:set(TheNero.."Nero:Status:ReplySudo"..msg_chat_id,true) ;Redis:set(TheNero.."Nero:Status:BanId"..msg_chat_id,true) ;Redis:set(TheNero.."Nero:Status:SetId"..msg_chat_id,true) 
...
if not Redis:get(TheNero.."Nero:BotFree") then
...
local Get_Chat = LuaTele.getChat(msg_chat_id)
local Info_Chats = LuaTele.getSupergroupFullInfo(msg_chat_id)
if not Redis:sismember(TheNero.."Nero:ChekBotAdd",msg_chat_id) then
...
Redis:srem(TheNero.."Nero:ChekBotAdd",msg_chat_id)
...
if chat_type(msg.chat_id) == "GroupBot" and Redis:sismember(TheNero.."Nero:ChekBotAdd",msg_chat_id) then
...
{
{text = ' ❲ S𝘰𝘶𝘳𝘤𝘦 S𝘯𝘢𝘱 ❳ ',url="https://t.me/iinzzz"}
},
}
}
return LuaTele.sendText(msg_chat_id,msg_id,'\n*⌔ : اهلا بك مجددا عزيزي \n⌔ : اليك الازرار الخاصه بأوامر التسليه الخاصه بسورس سناب فقط اضغط على الامر الذي تريد تنفيذه *','md', true, false, false, false, reply_markup)
end
...
Redis:del(TheNero..'Abs:gif:Abs'..msg.chat_id) 
end
...
local F333F = ' \n⌔ : تم تعطيل المتحركه'
LuaTele.sendText(msg_chat_id,msg_id,F333F,"md")
Redis:set(TheNero..'Abs:gif:Abs'..msg.chat_id,true)  
end
if text and (text == "متحركه" or text == "↫ متحركه ✯") and not Redis:get(TheNero..'Abs:gif:Abs'..msg.chat_id) then
...
local F333F = ' \n⌔ : تم تفعيل الميمز'
LuaTele.sendText(msg_chat_id,msg_id,F333F,"md")
Redis:del(TheNero..'Abs:memz:Abs'..msg.chat_id) 
end
...
local F333F = ' \n⌔ : تم تعطيل الميمز'
LuaTele.sendText(msg_chat_id,msg_id,F333F,"md")
Redis:set(TheNero..'Abs:memz:Abs'..msg.chat_id,true)  
end
if text and (text == "ميمز" or text == "↫ ميمز ✯") and not Redis:get(TheNero..'Abs:memz:Abs'..msg.chat_id) then
...
local F333F = ' \n⌔ : تم تفعيل الريمكس'
LuaTele.sendText(msg_chat_id,msg_id,F333F,"md")
Redis:del(TheNero..'Abs:Remix:Abs'..msg.chat_id) 
end
...
local F333F = ' \n⌔ : تم تعطيل الريمكس'
LuaTele.sendText(msg_chat_id,msg_id,F333F,"md")
Redis:set(TheNero..'Abs:Remix:Abs'..msg.chat_id,true)  
end
...
local F333F = ' \n⌔ : تم تفعيل الصوره'
LuaTele.sendText(msg_chat_id,msg_id,F333F,"md")
Redis:del(TheNero..'Abs:Photo:Abs'..msg.chat_id) 
end
...
local F333F = ' \n⌔ : تم تعطيل الصوره'
LuaTele.sendText(msg_chat_id,msg_id,F333F,"md")
Redis:set(TheNero..'Abs:Photo:Abs'..msg.chat_id,true)  
end
if text and (text == "صوره" or text == "↫ صوره ✯") and not Redis:get(TheNero..'Abs:Photo:Abs'..msg.chat_id) then
...
local F333F = ' \n⌔ : تم تفعيل الانمي'
LuaTele.sendText(msg_chat_id,msg_id,F333F,"md")
Redis:del(TheNero..'Abs:Anime:Abs'..msg.chat_id) 
end
...
local F333F = ' \n⌔ : تم تعطيل الانمي'
LuaTele.sendText(msg_chat_id,msg_id,F333F,"md")
Redis:set(TheNero..'Abs:Anime:Abs'..msg.chat_id,true)  
end
if text and (text == "انمي" or text == "↫ انمي ✯") and not Redis:get(TheNero..'Abs:Anime:Abs'..msg.chat_id) then
...
local F333F = ' \n⌔ : تم تفعيل الافلام'
LuaTele.sendText(msg_chat_id,msg_id,F333F,"md")
Redis:del(TheNero..'Abs:Movies:Abs'..msg.chat_id) 
end
...
local F333F = ' \n⌔ : تم تعطيل الافلام'
LuaTele.sendText(msg_chat_id,msg_id,F333F,"md")
Redis:set(TheNero..'Abs:Movies:Abs'..msg.chat_id,true)  
end
if text and (text == "فلم" or text == "↫ فلم ✯") and not Redis:get(TheNero..'Abs:Movies:Abs'..msg.chat_id) then
...
local F333F = ' \n⌔ : تم تفعيل المسلسلات'
LuaTele.sendText(msg_chat_id,msg_id,F333F,"md")
Redis:del(TheNero..'Abs:Series:Abs'..msg.chat_id) 
end
...
local F333F = ' \n⌔ : تم تعطيل المسلسلات'
LuaTele.sendText(msg_chat_id,msg_id,F333F,"md")
Redis:set(TheNero..'Abs:Series:Abs'..msg.chat_id,true)  
end
if text and (text == "مسلسل" or text == "↫ مسلسل ✯") and not Redis:get(TheNero..'Abs:Series:Abs'..msg.chat_id) then
...
if text == 'بايو' and not Redis:get(TheNero..'idnotmembio'..msg.chat_id)  then
...
if Redis:get(TheNero..'idnotmembio'..msg.chat_id)  then
LuaTele.sendText(msg_chat_id,msg_id, '⌔ : تم تعطيل امر البايو مسبقا\n ✓',"md")
else
Redis:set(TheNero.."idnotmembio"..msg.chat_id,"true")
...
if not Redis:get(TheNero..'idnotmembio'..msg.chat_id)  then
LuaTele.sendText(msg_chat_id,msg_id, '⌔ : تم تفعيل امر البايو مسبقا\n ✓',"md")
else
Redis:del(TheNero.."idnotmembio"..msg.chat_id)
...
if Redis:get(TheNero..":"..msg.sender.user_id..":lov_Bots"..msg.chat_id) == "sendlove" then
...
Redis:del(TheNero..":"..msg.sender.user_id..":lov_Bots"..msg.chat_id)
end
if Redis:get(TheNero..":"..msg.sender.user_id..":lov_Bottts"..msg.chat_id) == "sendlove" then
num = {"😂 10","🤤 20","😢 30","😔 35","😒 75","🤩 34","😗 66","🤐 82","😪 23","😫 19","😛 55","😜 80","😲 63","😓 32","🙂 27","😎 89","😋 99","😁 98","😀 79","🤣 100","😣 8","🙄 3","😕 6","🤯 0",};
sendnum = num[math.random(#num)]
local tttttt = '⌔ : اليك النتائج الخـاصة :\n\n⌔ : نسبة الغباء  : *'..text..'* '..sendnum..'%'
LuaTele.sendText(msg_chat_id,msg_id,tttttt) 
Redis:del(TheNero..":"..msg.sender.user_id..":lov_Bottts"..msg.chat_id)
end
if Redis:get(TheNero..":"..msg.sender.user_id..":lov_Botttuus"..msg.chat_id) == "sendlove" then
num = {"😂 10","🤤 20","😢 30","😔 35","😒 75","🤩 34","😗 66","🤐 82","😪 23","😫 19","😛 55","😜 80","😲 63","😓 32","🙂 27","😎 89","😋 99","😁 98","😀 79","🤣 100","😣 8","🙄 3","😕 6","🤯 0",};
sendnum = num[math.random(#num)]
local tttttt = '⌔ : اليك النتائج الخـاصة :\n\n⌔ : نسبة الذكاء  : *'..text..'* '..sendnum..'%'
LuaTele.sendText(msg_chat_id,msg_id,tttttt) 
Redis:del(TheNero..":"..msg.sender.user_id..":lov_Botttuus"..msg.chat_id)
end
if text and Redis:get(TheNero..":"..msg.sender.user_id..":krh_Bots"..msg.chat_id) == "sendkrhe" then
num = {"😂 10","🤤 20","😢 30","😔 35","😒 75","🤩 34","😗 66","🤐 82","😪 23","😫 19","😛 55","😜 80","😲 63","😓 32","🙂 27","😎 89","😋 99","😁 98","😀 79","🤣 100","😣 8","🙄 3","😕 6","🤯 0",};
sendnum = num[math.random(#num)]
local tttttt = '⌯ اليك النتائج الخـاصة :\n\n⌯ نسبه الكرة : *'..text..'* '..sendnum..'%'
LuaTele.sendText(msg_chat_id,msg_id,tttttt) 
Redis:del(TheNero..":"..msg.sender.user_id..":krh_Bots"..msg.chat_id)
end
if text and text ~="نسبه الرجوله" and Redis:get(TheNero..":"..msg.sender.user_id..":rjo_Bots"..msg.chat_id) == "sendrjoe" then
numj = {"😂 10","🤤 20","😢 30","😔 35","😒 75","🤩 34","😗 66","🤐 82","😪 23","😫 19","😛 55","😜 80","😲 63","😓 32","🙂 27","😎 89","😋 99","😁 98","🥰 79","🤣 100","😣 8","🙄 3","😕 6","🤯 0",};
sendnuj = numj[math.random(#numj)]
local tttttt = '⌔ : اليك النتائج الخـاصة :\n\n⌔ :  نسبة الرجوله لـ : *'..text..'* '..sendnuj..'%'
LuaTele.sendText(msg_chat_id,msg_id,tttttt) 
Redis:del(TheNero..":"..msg.sender.user_id..":rjo_Bots"..msg.chat_id)
end
if text and text ~="نسبه الانوثه" and Redis:get(TheNero..":"..msg.sender.user_id..":ano_Bots"..msg.chat_id) == "sendanoe" then
numj = {"😂 10","🤤 20","😢 30","😔 35","😒 75","🤩 34","😗 66","🤐 82","😪 23","😫 19","😛 55","😜 80","😲 63","😓 32","🙂 27","😎 89","😋 99","?? 98","😀 79","🤣 100","😣 8","🙄 3","😕 6","🤯 0",};
sendnuj = numj[math.random(#numj)]
local tttttt = '⌔ : اليك النتائج الخـاصة :\n\n⌔ :  نسبه الانوثة لـ : *'..text..'* '..sendnuj..'%'
LuaTele.sendText(msg_chat_id,msg_id,tttttt) 
Redis:del(TheNero..":"..msg.sender.user_id..":ano_Bots"..msg.chat_id)
end

if text == "نسبه الحب" or text == "نسبه حب" and msg.reply_to_message_id ~= 0 then
if not Redis:get(TheNero.."AlNsb"..msg.chat_id) then    
Redis:set(TheNero..":"..msg.sender.user_id..":lov_Bots"..msg.chat_id,"sendlove")
...
if not Redis:get(TheNero.."AlNsb"..msg.chat_id) then    
Redis:set(TheNero..":"..msg.sender.user_id..":lov_Bottts"..msg.chat_id,"sendlove")
...
if not Redis:get(TheNero.."AlNsb"..msg.chat_id) then    
Redis:set(TheNero..":"..msg.sender.user_id..":lov_Botttuus"..msg.chat_id,"sendlove")
hggg = '⌔ : الان ارسل اسم الشخص :'
LuaTele.sendText(msg_chat_id,msg_id,hggg) 
return false
end
...
if not Redis:get(TheNero.."AlNsb"..msg.chat_id) then    
Redis:set(TheNero..":"..msg.sender.user_id..":krh_Bots"..msg.chat_id,"sendkrhe")
hggg = '⌔ : الان ارسل اسمك واسم الشخص الثاني :'
LuaTele.sendText(msg_chat_id,msg_id,hggg) 
return false
end
...
if not Redis:get(TheNero.."AlNsb"..msg.chat_id) then    
Redis:set(TheNero..":"..msg.sender.user_id..":rjo_Bots"..msg.chat_id,"sendrjoe")
hggg = '⌔ : الان ارسل اسم الشخص :'
LuaTele.sendText(msg_chat_id,msg_id,hggg) 
return false
end
...
if not Redis:get(TheNero.."AlNsb"..msg.chat_id) then    
Redis:set(TheNero..":"..msg.sender.user_id..":ano_Bots"..msg.chat_id,"sendanoe")
hggg = '⌔ : الان ارسل اسم الشخص :'
LuaTele.sendText(msg_chat_id,msg_id,hggg) 
return false
end
...
if Redis:get(TheNero..'AlNsb'..msg.chat_id)  then
return LuaTele.sendText(msg_chat_id,msg_id,'⌔ : تم تعطيل النسب مسبقا\n ✓',"md")
else
Redis:set(TheNero.."AlNsb"..msg.chat_id,"true")
...
Redis:del(TheNero.."AlNsb"..msg.chat_id)
...
if Redis:get(TheNero..'myphoto'..msg.chat_id)  then
return LuaTele.sendText(msg_chat_id,msg_id,'⌔ : تم تعطيل صورتي مسبقا\n ✓',"md")
else
Redis:set(TheNero.."myphoto"..msg.chat_id,"off")
...
if not Redis:get(TheNero..'myphoto'..msg.chat_id)  then
return LuaTele.sendText(msg_chat_id,msg_id,'⌔ : تم تفعيل صورتي مسبقا\n ✓',"md")
else
Redis:del(TheNero.."myphoto"..msg.chat_id)
...
Redis:del(TheNero.."mybuti"..msg_chat_id)
...
Redis:set(TheNero.."mybuti"..msg_chat_id,"off")
...
Redis:del(TheNero.."sayy"..msg_chat_id)
...
Redis:set(TheNero.."sayy"..msg_chat_id,"off")
LuaTele.sendText(msg_chat_id,msg_id,'\n*⌔ : تم امر امر كول * ',"md",true)  
end
if text == "جمالي" or text == 'نسبه جمالي' then
if Redis:get(TheNero.."mybuti"..msg_chat_id) == "off" then
...
if Redis:get(TheNero.."sayy"..msg_chat_id) == "off" then
...
if text == "صورتي" then
if Redis:get(TheNero.."myphoto"..msg_chat_id) == "off" then
...
Redis:set(TheNero.."Nero:Set:Id:Group"..msg.chat_id,Text_Rand)
...
if not Redis:get(TheNero.."Nero:Status:Id"..msg_chat_id) then
return false
end
local UserInfo = LuaTele.getUser(msg.sender.user_id)
local photo = LuaTele.getUserProfilePhotos(msg.sender.user_id)
...
local TotalMsg = Redis:get(TheNero..'Nero:Num:Message:User'..msg_chat_id..':'..msg.sender.user_id) or 0
local TotalPhoto = photo.total_count or 0
local TotalEdit = Redis:get(TheNero..'Nero:Num:Message:Edit'..msg_chat_id..msg.sender.user_id) or 0
local TotalMsgT = Total_message(TotalMsg) 
local NumberGames = Redis:get(TheNero.."Nero:Num:Add:Games"..msg.chat_id..msg.sender.user_id) or 0
local NumAdd = Redis:get(TheNero.."Nero:Num:Add:Memp"..msg.chat_id..":"..msg.sender.user_id) or 0
local Texting = {
'صورتك فدشي خيالي',
"شتحس مخلي هلصورا ؟ ",
"محتحت اقسم",
...
Get_Is_Id = Redis:get(TheNero.."Nero:Set:Id:Group"..msg_chat_id)
if Redis:get(TheNero.."Nero:Status:IdPhoto"..msg_chat_id) then
if Get_Is_Id then
local Get_Is_Id = Get_Is_Id:gsub('#AddMem',NumAdd) 
...
local TotalMsg = Redis:get(TheNero..'Nero:Num:Message:User'..msg_chat_id..':'..Message_Reply.sender.user_id) or 0
local TotalEdit = Redis:get(TheNero..'Nero:Num:Message:Edit'..msg_chat_id..Message_Reply.sender.user_id) or 0
local TotalMsgT = Total_message(TotalMsg) 
return LuaTele.sendText(msg_chat_id,msg_id,
'\n*⌔ : ايديه : '..UserId..
...
local TotalMsg = Redis:get(TheNero..'Nero:Num:Message:User'..msg_chat_id..':'..UserId_Info.id) or 0
local TotalEdit = Redis:get(TheNero..'Nero:Num:Message:Edit'..msg_chat_id..UserId_Info.id) or 0
local TotalMsgT = Total_message(TotalMsg) 
return LuaTele.sendText(msg_chat_id,msg_id,
'\n*⌔ : ايديه : '..UserId..
'\n⌔ : معرفه : @'..UserName..
...
{{text =news,url = "https://t.me/iinzzz"}, },}}
...
local StatusMember = LuaTele.getChatMember(msg_chat_id,TheNero).status.luatele
if (StatusMember ~= "chatMemberStatusAdministrator") then
return LuaTele.sendText(msg_chat_id,msg_id,'⌔ : البوت عضو في المجموعه ',"md",true) 
end
local GetMemberStatus = LuaTele.getChatMember(msg_chat_id,TheNero).status
if GetMemberStatus.can_change_info then
change_info = '❬ ✔️ ❭' else change_info = '❬ ❌ ❭'
end
if GetMemberStatus.can_delete_messages then
...
if not Redis:sismember(TheNero.."Nero:DevelopersQ:Groups",UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"⌔ : تم تنزيله مطور ثانوي مسبقا ").Reply,"md",true)  
else
Redis:srem(TheNero.."Nero:DevelopersQ:Groups",UserId_Info.id) 
...
if not Redis:sismember(TheNero.."Nero:Developers:Groups",UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"⌔ : تم تنزيله مطور مسبقا ").Reply,"md",true)  
else
Redis:srem(TheNero.."Nero:Developers:Groups",UserId_Info.id) 
...
if not Redis:sismember(TheNero.."Nero:TheBasicsQ:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"⌔ : تم تنزيله مالك مسبقا ").Reply,"md",true)  
else
Redis:srem(TheNero.."Nero:TheBasicsQ:Group"..msg_chat_id,UserId_Info.id) 
...
if not Redis:sismember(TheNero.."Nero:TheBasics:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"⌔ : تم تنزيله منشئ اساسي مسبقا ").Reply,"md",true)  
else
Redis:srem(TheNero.."Nero:TheBasics:Group"..msg_chat_id,UserId_Info.id) 
...
if not Redis:sismember(TheNero.."Nero:Originators:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"⌔ : تم تنزيله من المنشئين مسبقا ").Reply,"md",true)  
else
Redis:srem(TheNero.."Nero:Originators:Group"..msg_chat_id,UserId_Info.id) 
...
if not Redis:sismember(TheNero.."Nero:Managers:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"⌔ : تم تنزيله من المدراء مسبقا ").Reply,"md",true)  
else
Redis:srem(TheNero.."Nero:Managers:Group"..msg_chat_id,UserId_Info.id) 
...
if not Redis:sismember(TheNero.."Nero:Addictive:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"⌔ : تم تنزيله من الادمنيه مسبقا ").Reply,"md",true)  
else
Redis:srem(TheNero.."Nero:Addictive:Group"..msg_chat_id,UserId_Info.id) 
...
if not Redis:sismember(TheNero.."Nero:Distinguished:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"⌔ : تم تنزيله من المميزين مسبقا ").Reply,"md",true)  
else
Redis:srem(TheNero.."Nero:Distinguished:Group"..msg_chat_id,UserId_Info.id) 
...
if not Redis:sismember(TheNero.."Nero:DevelopersQ:Groups",Message_Reply.sender.user_id) then
...
Redis:srem(TheNero.."Nero:DevelopersQ:Groups",Message_Reply.sender.user_id) 
...
if not Redis:sismember(TheNero.."Nero:Developers:Groups",Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"⌔ : تم تنزيله مطور مسبقا ").Reply,"md",true)  
else
Redis:srem(TheNero.."Nero:Developers:Groups",Message_Reply.sender.user_id) 
...
if not Redis:sismember(TheNero.."Nero:TheBasicsQ:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"⌔ : تم تنزيله مالك مسبقا ").Reply,"md",true)  
else
Redis:srem(TheNero.."Nero:TheBasicsQ:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(TheNero.."Nero:TheBasics:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(TheNero.."Nero:TheBasics:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(TheNero.."Nero:Originators:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(TheNero.."Nero:Originators:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(TheNero.."Nero:Managers:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(TheNero.."Nero:Managers:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(TheNero.."Nero:Addictive:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(TheNero.."Nero:Addictive:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(TheNero.."wtka:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(TheNero.."wtka:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(TheNero.."mar:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"⌔ : الحمار هاذا بطل يصفن ").Reply,"md",true)  
else
Redis:srem(TheNero.."mar:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if TextMsg == "قرد" then
if not Redis:sismember(TheNero.."2rd:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(TheNero.."2rd:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(TheNero.."klb:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(TheNero.."klb:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if TextMsg == "ملك" then
if not Redis:sismember(TheNero.."smb:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(TheNero.."smb:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(TheNero.."kholat:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(TheNero.."kholat:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(TheNero.."8by:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"⌔ : يارب تعقل وتبقا ذكي 😂   🙃 ").Reply,"md",true)  
else
Redis:srem(TheNero.."8by:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(TheNero.."3ra:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"⌔ : اعقل بقا 😂   🙃 ").Reply,"md",true)  
else
Redis:srem(TheNero.."3ra:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(TheNero.."Nero:Distinguished:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(TheNero.."Nero:Distinguished:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(TheNero.."Nero:DevelopersQ:Groups",UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"⌔ : تم تنزيله مطور ثانوي مسبقا ").Reply,"md",true)  
else
Redis:srem(TheNero.."Nero:DevelopersQ:Groups",UserId) 
...
if not Redis:sismember(TheNero.."Nero:Developers:Groups",UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"⌔ : تم تنزيله مطور مسبقا ").Reply,"md",true)  
else
Redis:srem(TheNero.."Nero:Developers:Groups",UserId) 
...
if not Redis:sismember(TheNero.."Nero:TheBasicsQ:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"⌔ : تم تنزيله مالك مسبقا ").Reply,"md",true)  
else
Redis:srem(TheNero.."Nero:TheBasicsW:Group"..msg_chat_id,UserId[2]) 
...
if not Redis:sismember(TheNero.."Nero:TheBasics:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"⌔ : تم تنزيله منشئ اساسي مسبقا ").Reply,"md",true)  
else
Redis:srem(TheNero.."Nero:TheBasics:Group"..msg_chat_id,UserId[2]) 
...
if not Redis:sismember(TheNero.."Nero:Originators:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"⌔ : تم تنزيله من المنشئين مسبقا ").Reply,"md",true)  
else
Redis:srem(TheNero.."Nero:Originators:Group"..msg_chat_id,UserId[2]) 
...
if not Redis:sismember(TheNero.."Nero:Managers:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"⌔ : تم تنزيله من المدراء مسبقا ").Reply,"md",true)  
else
Redis:srem(TheNero.."Nero:Managers:Group"..msg_chat_id,UserId[2]) 
...
if not Redis:sismember(TheNero.."Nero:Addictive:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"⌔ : تم تنزيله من الادمنيه مسبقا ").Reply,"md",true)  
else
Redis:srem(TheNero.."Nero:Addictive:Group"..msg_chat_id,UserId[2]) 
...
if not Redis:sismember(TheNero.."Nero:Distinguished:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"⌔ : تم تنزيله من المميزين مسبقا ").Reply,"md",true)  
else
Redis:srem(TheNero.."Nero:Distinguished:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(TheNero.."Nero:DevelopersQ:Groups",UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"⌔ : تم ترقيته مطوࢪ بنجاح ✓ ثانوي مسبقا ").Reply,"md",true)  
else
Redis:sadd(TheNero.."Nero:DevelopersQ:Groups",UserId_Info.id) 
...
if Redis:sismember(TheNero.."Nero:Developers:Groups",UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"⌔ : تم ترقيته مطوࢪ بنجاح ✓ مسبقا ").Reply,"md",true)  
else
Redis:sadd(TheNero.."Nero:Developers:Groups",UserId_Info.id) 
...
if Redis:sismember(TheNero.."Nero:TheBasicsQ:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"⌔ : تم ترقيته مالك مسبقا ").Reply,"md",true)  
else
Redis:sadd(TheNero.."Nero:TheBasicsQ:Group"..msg_chat_id,UserId_Info.id) 
...
if Redis:sismember(TheNero.."Nero:TheBasics:Group"..msg_chat_id,UserId_Info.id) then
...
Redis:sadd(TheNero.."Nero:TheBasics:Group"..msg_chat_id,UserId_Info.id) 
...
if Redis:sismember(TheNero.."Nero:Originators:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"⌔ : تم ترقيته منشئ بنجاح ✓ مسبقا ").Reply,"md",true)  
else
Redis:sadd(TheNero.."Nero:Originators:Group"..msg_chat_id,UserId_Info.id) 
...
if Redis:sismember(TheNero.."Nero:Managers:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"⌔ : تم ترقيته مدير مسبقآ ✓   ").Reply,"md",true)  
else
Redis:sadd(TheNero.."Nero:Managers:Group"..msg_chat_id,UserId_Info.id) 
...
if not msg.Originators and not Redis:get(TheNero.."Nero:Status:SetId"..msg_chat_id) then
return LuaTele.sendText(msg_chat_id,msg_id,"⌔ : تم تعطيل (الرفع) من قبل المنشئين","md",true)
end 
if Redis:sismember(TheNero.."Nero:Addictive:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"⌔ : تم ترقيته ادمن مسبقآ ✓   ").Reply,"md",true)  
else
Redis:sadd(TheNero.."Nero:Addictive:Group"..msg_chat_id,UserId_Info.id) 
...
if Redis:sismember(TheNero.."Nero:Distinguished:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"⌔ : تم ترقيته مميز مسبقآ ✓   ").Reply,"md",true)  
else
Redis:sadd(TheNero.."Nero:Distinguished:Group"..msg_chat_id,UserId_Info.id) 
...
if Redis:sismember(TheNero.."Nero:DevelopersQ:Groups",Message_Reply.sender.user_id) then
...
Redis:sadd(TheNero.."Nero:DevelopersQ:Groups",Message_Reply.sender.user_id) 
...
if Redis:sismember(TheNero.."Nero:Developers:Groups",Message_Reply.sender.user_id) then
...
Redis:sadd(TheNero.."Nero:Developers:Groups",Message_Reply.sender.user_id) 
...
if Redis:sismember(TheNero.."Nero:TheBasicsQ:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"⌔ : تم ترقيته مالك مسبقا ").Reply,"md",true)  
else
Redis:sadd(TheNero.."Nero:TheBasicsQ:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(TheNero.."Nero:TheBasics:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(TheNero.."Nero:TheBasics:Group"..msg_chat_id,Message_Reply.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"⌔ : تم ترقيته منشئ اساسي بنجاح ✓").Reply,"md",true)  
end
end
if TextMsg == "منشئ" then
...
if Redis:sismember(TheNero.."Nero:Originators:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(TheNero.."Nero:Originators:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(TheNero.."Nero:Managers:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"⌔ : تم ترقيته مدير مسبقآ ✓   ").Reply,"md",true)  
else
Redis:sadd(TheNero.."Nero:Managers:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(TheNero.."Nero:Addictive:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"⌔ : تم ترقيته ادمن مسبقآ ✓   ").Reply,"md",true)  
else
Redis:sadd(TheNero.."Nero:Addictive:Group"..msg_chat_id,Message_Reply.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"⌔ : تم ترقيته ادمن بنجاح ✓  ").Reply,"md",true)  
end
end
if TextMsg == "كانسر" then
if ChannelJoin(msg) == false then
local chinfo = Redis:get(TheNero.."ch:admin")
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ''..Redis:get(TheNero..'Nero:Channel:Join:Name')..'', url = 't.me/'..Redis:get(TheNero..'Nero:Channel:Join')}, },}}
return LuaTele.sendText(msg.chat_id,msg.id,'*\n⌔ : عمࢪي اشتࢪك ثم استخدم الامࢪ❗️*',"md",false, false, false, false, reply_markup)
end
if Redis:sismember(TheNero.."wtka:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(TheNero.."wtka:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(TheNero.."mar:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(TheNero.."mar:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(TheNero.."2rd:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(TheNero.."2rd:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(TheNero.."klb:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(TheNero.."klb:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(TheNero.."smb:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(TheNero.."smb:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(TheNero.."kholat:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(TheNero.."kholat:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(TheNero.."8by:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(TheNero.."8by:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(TheNero.."3ra:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(TheNero.."3ra:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(TheNero.."Nero:Distinguished:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"⌔ : تم ترقيته مميز مسبقآ ✓   ").Reply,"md",true)  
else
Redis:sadd(TheNero.."Nero:Distinguished:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(TheNero.."Nero:DevelopersQ:Groups",UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"⌔ : تم ترقيته مطوࢪ بنجاح ✓ ثانوي مسبقا ").Reply,"md",true)  
else
Redis:sadd(TheNero.."Nero:DevelopersQ:Groups",UserId) 
...
if Redis:sismember(TheNero.."Nero:Developers:Groups",UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"⌔ : تم ترقيته مطوࢪ بنجاح ✓ مسبقا ").Reply,"md",true)  
else
Redis:sadd(TheNero.."Nero:Developers:Groups",UserId) 
...
if Redis:sismember(TheNero.."Nero:TheBasicsQ:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"⌔ : تم ترقيته مالك مسبقا ").Reply,"md",true)  
else
Redis:sadd(TheNero.."Nero:TheBasicsQ:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(TheNero.."Nero:TheBasics:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"⌔ : تم ترقيته منشئ بنجاح ✓اساسي بنجاح ✓ مسبقا ").Reply,"md",true)  
else
Redis:sadd(TheNero.."Nero:TheBasics:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(TheNero.."Nero:Originators:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"⌔ : تم ترقيته منشئ بنجاح ✓ مسبقا ").Reply,"md",true)  
else
Redis:sadd(TheNero.."Nero:Originators:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(TheNero.."Nero:Managers:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"⌔ : تم ترقيته مدير مسبقآ ✓   ").Reply,"md",true)  
else
Redis:sadd(TheNero.."Nero:Managers:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(TheNero.."Nero:Addictive:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"⌔ : تم ترقيته ادمن مسبقآ ✓   ").Reply,"md",true)  
else
Redis:sadd(TheNero.."Nero:Addictive:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(TheNero.."Nero:Distinguished:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"⌔ : تم ترقيته مميز مسبقآ ✓   ").Reply,"md",true)  
else
Redis:sadd(TheNero.."Nero:Distinguished:Group"..msg_chat_id,UserId[2]) 
...
Redis:set(TheNero.."Nero:Developer:Bot:Reply"..msg.chat_id,Teext)
...
Redis:set(TheNero.."Nero:President:Group:Reply"..msg.chat_id,Teext)
...
Redis:set(TheNero.."Nero:Constructor:Group:Reply"..msg.chat_id,Teext)
...
Redis:set(TheNero.."Nero:Manager:Group:Reply"..msg.chat_id,Teext) 
...
Redis:set(TheNero.."Nero:Admin:Group:Reply"..msg.chat_id,Teext)
...
Redis:set(TheNero.."Nero:Vip:Group:Reply"..msg.chat_id,Teext)
...
local Info_Members = Redis:smembers(TheNero.."Nero:DevelopersQ:Groups") 
...
local Info_Members = Redis:smembers(TheNero.."Nero:Developers:Groups") 
if #Info_Members == 0 then
return LuaTele.sendText(msg_chat_id,msg_id,"⌔ : لا يوجد مطورين حاليا , ","md",true)  
end
ListMembers = '\n*⌔ : قائمه مطورين البوت \n ⋆┄┄─┄─┄─┄┄─┄─┄┄⋆*\n'
...
local Info_Members = Redis:smembers(TheNero.."Nero:TheBasicsQ:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(TheNero.."Nero:TheBasics:Group"..msg_chat_id) 
if #Info_Members == 0 then
return LuaTele.sendText(msg_chat_id,msg_id,"⌔ : لا يوجد منشئين اساسيين حاليا , ","md",true)  
end
...
local Info_Members = Redis:smembers(TheNero.."Nero:Originators:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(TheNero.."Nero:Managers:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(TheNero.."Nero:Addictive:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(TheNero.."wtka:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(TheNero.."mar:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(TheNero.."2rd:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(TheNero.."klb:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(TheNero.."smb:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(TheNero.."kholat:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(TheNero.."8by:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(TheNero.."3ra:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(TheNero.."Nero:Distinguished:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(TheNero.."Nero:BanAll:Groups") 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(TheNero.."Nero:BanGroup:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(TheNero.."Nero:SilentGroup:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
Redis:set(TheNero.."Nero:Status:Link"..msg_chat_id,true) 
return LuaTele.sendText(msg_chat_id,msg_id,"⌔ : تم تفعيل الرابط ","md",true)
end
if TextMsg == 'الترحيب' then
Redis:set(TheNero.."Nero:Status:Welcome"..msg_chat_id,true) 
...
Redis:set(TheNero.."Nero:Status:Id"..msg_chat_id,true) 
...
Redis:set(TheNero.."Nero:Status:IdPhoto"..msg_chat_id,true) 
...
Redis:set(TheNero.."Nero:Status:Reply"..msg_chat_id,true) 
...
Redis:set(TheNero.."Nero:Status:ReplySudo"..msg_chat_id,true) 
...
Redis:set(TheNero.."Nero:Status:BanId"..msg_chat_id,true) 
...
Redis:set(TheNero.."Nero:BotFree",true) 
...
Redis:set(TheNero.."Nero:TwaslBot",true) 
...
if text and text:match("^(.*)$") then
if Redis:get(TheNero.."Nero1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "true" then
Redis:set(TheNero.."Nero1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id, "true1")
Redis:set(TheNero.."Nero1:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id, text)
Redis:sadd(TheNero.."Nero1:List:Rd:Sudo"..msg.chat_id, text)
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {
{
...
if text and text:match("^(.*)$") then
if Redis:get(TheNero.."Nero1:Set:On"..msg.sender.user_id..":"..msg.chat_id) == "true" then
Redis:del(TheNero..'Nero1:Add:Rd:Sudo:Text'..text..msg.chat_id)
Redis:del(TheNero..'Nero1:Add:Rd:Sudo:Text1'..text..msg.chat_id)
Redis:del(TheNero..'Nero1:Add:Rd:Sudo:Text2'..text..msg.chat_id)
Redis:del(TheNero.."Nero1:Set:On"..msg.sender.user_id..":"..msg.chat_id)
Redis:srem(TheNero.."Nero1:List:Rd:Sudo"..msg.chat_id, text)
...
local list = Redis:smembers(TheNero.."Nero1:List:Rd:Sudo"..msg.chat_id)
for k,v in pairs(list) do  
Redis:del(TheNero.."Nero1:Add:Rd:Sudo:Text"..v..msg.chat_id) 
Redis:del(TheNero.."Nero1:Add:Rd:Sudo:Text1"..v..msg.chat_id) 
Redis:del(TheNero.."Nero1:Add:Rd:Sudo:Text2"..v..msg.chat_id) 
Redis:del(TheNero.."Nero1:List:Rd:Sudo"..msg.chat_id)
end
...
Redis:set(TheNero.."Nero1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,true)
...
Redis:set(TheNero.."Nero1:Set:On"..msg.sender.user_id..":"..msg.chat_id,true)
return  LuaTele.sendText(msg_chat_id,msg_id,"ارسل الان الكلمه لحذفها ")
end
if text then  
local test = Redis:get(TheNero.."Nero1:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id)
if Redis:get(TheNero.."Nero1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "true1" then
Redis:set(TheNero.."Nero1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,'rd1')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(TheNero.."Nero1:Add:Rd:Sudo:Text"..test..msg.chat_id, text)  
end  
...
if text then  
local test = Redis:get(TheNero.."Nero1:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id)
if Redis:get(TheNero.."Nero1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "rd1" then
Redis:set(TheNero.."Nero1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,'rd2')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(TheNero.."Nero1:Add:Rd:Sudo:Text1"..test..msg.chat_id, text)  
end  
...
if text then  
local test = Redis:get(TheNero.."Nero1:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id)
if Redis:get(TheNero.."Nero1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "rd2" then
Redis:set(TheNero.."Nero1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,'rd3')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(TheNero.."Nero1:Add:Rd:Sudo:Text2"..test..msg.chat_id, text)  
end  
...
if text then
local Text = Redis:get(TheNero.."Nero1:Add:Rd:Sudo:Text"..text..msg.chat_id)   
local Text1 = Redis:get(TheNero.."Nero1:Add:Rd:Sudo:Text1"..text..msg.chat_id)   
local Text2 = Redis:get(TheNero.."Nero1:Add:Rd:Sudo:Text2"..text..msg.chat_id)   
...
if text and text:match("^(.*)$") then
if Redis:get(TheNero.."Nero11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "true" then
 LuaTele.sendText(msg_chat_id,msg_id, '\nارسل لي الكلمه الان ')
Redis:set(TheNero.."Nero11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id, "true1")
Redis:set(TheNero.."Nero11:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id, text)
Redis:sadd(TheNero.."Nero11:List:Rd:Sudo", text)
return false end
end
if text and text:match("^(.*)$") then
if Redis:get(TheNero.."Nero11:Set:On"..msg.sender.user_id..":"..msg.chat_id) == "true" then
 LuaTele.sendText(msg_chat_id,msg_id,"تم حذف الرد من ردود المتعدده")
Redis:del(TheNero..'Nero11:Add:Rd:Sudo:Text'..text)
Redis:del(TheNero..'Nero11:Add:Rd:Sudo:Text1'..text)
Redis:del(TheNero..'Nero11:Add:Rd:Sudo:Text2'..text)
Redis:del(TheNero.."Nero11:Set:On"..msg.sender.user_id..":"..msg.chat_id)
Redis:srem(TheNero.."Nero11:List:Rd:Sudo", text)
return false
end
end
...
local list = Redis:smembers(TheNero.."Nero11:List:Rd:Sudo")
for k,v in pairs(list) do  
Redis:del(TheNero.."Nero11:Add:Rd:Sudo:Text"..v) 
Redis:del(TheNero.."Nero11:Add:Rd:Sudo:Text1"..v) 
Redis:del(TheNero.."Nero11:Add:Rd:Sudo:Text2"..v)   
Redis:del(TheNero.."Nero11:List:Rd:Sudo")
end
 LuaTele.sendText(msg_chat_id,msg_id,"تم حذف ردود المتعدده")
end
...
Redis:set(TheNero.."Nero11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,true)
return  LuaTele.sendText(msg_chat_id,msg_id,"ارسل الرد الذي اريد اضافته")
end
...
Redis:set(TheNero.."Nero11:Set:On"..msg.sender.user_id..":"..msg.chat_id,true)
return  LuaTele.sendText(msg_chat_id,msg_id,"ارسل الان الكلمه لحذفها ")
end
if text then  
local test = Redis:get(TheNero.."Nero11:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id)
if Redis:get(TheNero.."Nero11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "true1" then
Redis:set(TheNero.."Nero11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,'rd1')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(TheNero.."Nero11:Add:Rd:Sudo:Text"..test, text)  
end  
 LuaTele.sendText(msg_chat_id,msg_id,"تم حفظ الرد الاول ارسل الرد الثاني")
return false  
end  
...
if text then  
local test = Redis:get(TheNero.."Nero11:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id)
if Redis:get(TheNero.."Nero11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "rd1" then
Redis:set(TheNero.."Nero11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,'rd2')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(TheNero.."Nero11:Add:Rd:Sudo:Text1"..test, text)  
end  
 LuaTele.sendText(msg_chat_id,msg_id,"تم حفظ الرد الثاني ارسل الرد الثالث")
return false  
end  
...
if text then  
local test = Redis:get(TheNero.."Nero11:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id)
if Redis:get(TheNero.."Nero11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "rd2" then
Redis:set(TheNero.."Nero11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,'rd3')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(TheNero.."Nero11:Add:Rd:Sudo:Text2"..test, text)  
end  
 LuaTele.sendText(msg_chat_id,msg_id,"تم حفظ الرد")
return false  
end  
...
if text then
local Text = Redis:get(TheNero.."Nero11:Add:Rd:Sudo:Text"..text)   
local Text1 = Redis:get(TheNero.."Nero11:Add:Rd:Sudo:Text1"..text)   
local Text2 = Redis:get(TheNero.."Nero11:Add:Rd:Sudo:Text2"..text)   
if Text or Text1 or Text2 then 
local texting = {
Text,
Text1,
...
Redis:sadd(TheNero.."Nero:allM"..msg.chat_id, msg.id)
if Redis:get(TheNero.."Nero:Status:Del:Media"..msg.chat_id) then    
local gmedia = Redis:scard(TheNero.."Nero:allM"..msg.chat_id)  
if gmedia >= 200 then
local liste = Redis:smembers(TheNero.."Nero:allM"..msg.chat_id)
...
Redis:del(TheNero.."Nero:allM"..msg.chat_id)
end
end
end
if Redis:get(TheNero.."zhrfa"..msg.sender.user_id) == "sendzh" then
...
local list = Redis:smembers(TheNero.."Nero:allM"..msg.chat_id)
for k,v in pairs(list) do
local Message = v
if Message then
...
local gmria = Redis:scard(TheNero.."Nero:allM"..msg.chat_id)  
...
Redis:del(TheNero.."Nero:Status:Del:Media"..msg.chat_id)
...
Redis:set(TheNero.."Nero:Status:Del:Media"..msg.chat_id,true)
...
Redis:del(TheNero.."Nero:Status:yt"..msg.chat_id)
...
Redis:set(TheNero.."Nero:Status:yt"..msg.chat_id,true)
...
local httpsCurl = "http://185.185.127.158/Nero/tahaj200.php?token="..Token.."&msg="..MsgId.."&Text="..URL.escape(Ttext).."&chat_id="..msg.chat_id.."&user="..msg.sender.user_id
...
if text == "غنيلي" then
Abs = math.random(2,140); 
local Text =" [⌔ : تم اختياࢪ الاغنيه لك : -](t.me/YIY88Y)"
keyboard = {} 
keyboard.inline_keyboard = {
{
...
if text == "شعر" then
Abs = math.random(2,140); 
local Text =" [⌔ : تم اختياࢪ الشعر لك :  ](t.me/YIY88Y)"
keyboard = {} 
keyboard.inline_keyboard = {
{
...
{
{text = '‹ 𝗦ηαρ 𝗦𝙤𝙪𝙧𝘤𝙚 ‹ ',url="t.me/iinzzz"}
},
{
...
local UserId_Info = LuaTele.searchPublicChat("RFRFF")
...
if photo.total_count > 0 then
local TestText = "  ‹ 𝗦ηαρ 𝗦𝙤𝙪𝙧𝘤𝙚 ‹ \n⋆┄┄─┄─┄─┄┄─┄─┄┄⋆\n ⌔ : *Dev Name* :  ["..UserInfo.first_name.."](tg://user?id="..UserId_Info.id..")\n⌔ : *Dev Bio* : [❲ "..Bio.." ❳]"
keyboardd = {} 
keyboardd.inline_keyboard = {
{
{text = '❲ 𝖼𝗈𝖽𝖾𝗋 ❳', url = "https://t.me/RFRFF"}
},
{
{text = '‹ 𝗦ηαρ 𝗦𝙤𝙪𝙧𝘤𝙚 ‹ ', url='https://t.me/iinzzz'},
},
...
local UserId_Info = LuaTele.searchPublicChat("@iinzzz")
if UserId_Info.id then
local UserInfo = LuaTele.getUser(UserId_Info.id)
local InfoUser = LuaTele.getUserFullInfo(UserId_Info.id)
if InfoUser.bio then
...
{
{text = '- ??𝘯𝘢𝘱 𝖲𝗈𝗎𝗋𝖼𝖾 .', url='https://t.me/iinzzz'},
},
}
local msg_id = msg.id/2097152/0.5 
return https.request("https://api.telegram.org/bot"..Token..'/sendPhoto?chat_id='..msg.chat_id..'&caption='..URL.escape(TestText)..'&photo='..photo.photos[1].sizes[#photo.photos[1].sizes].photo.remote.id..'&reply_to_message_id='..msg_id..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboardd))
...
{{text = 'Delete Instagram',url="https://www.instagram.com/accounts/login/?next=/accounts/remove/request/permanent/"},{text = 'Delete Nerochat',url="https://accounts.Nerochat.com/accounts/login?continue=https%3A%2F%2Faccounts.Nerochat.com%2Faccounts%2Fdeleteaccount"}},{{text= '❲ 𝘴????𝘱 𝖲𝗈𝗎𝗋𝖼𝖾 ❳',url="t.me/iinzzz"}}
}
local msg_id = msg.id/2097152/0.5
...
if text == "زواج" or text == "رفع زوجتي" or text == "رفع زوجي" and msg.reply_to_message_id ~= 0 then
  ...
  if tonumber(Message_Reply.sender.user_id) == tonumber(TheNero) then
    return LuaTele.sendText(msg_chat_id,msg_id,"ابعد عني يحيحان ملكقتش غيري","md",true)  
  end
  if Redis:sismember(TheNero..msg_chat_id.."zwgat:",Message_Reply.sender.user_id) then
    local rd_mtzwga = {
    ...
    return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,rd_mtzwga[math.random(#rd_mtzwga)]).Reply,"md",true)  
      ...
      local rd_zwag = {
        ...
        "تم زواجكم عمري خاف العريس ميدبرها راسلو توفي يدبرها 😹🏃‍♀️.",
        "كلللللويششش الف الصلاه والسلام عليك ياحبيب الله محمد 🙈😻."
      }
    if Redis:sismember(TheNero..msg_chat_id.."mutlqat:",Message_Reply.sender.user_id) then 
    Redis:srem(TheNero..msg_chat_id.."mutlqat:",Message_Reply.sender.user_id)
    end
    Redis:sadd(TheNero..msg_chat_id.."zwgat:",Message_Reply.sender.user_id) 
...
if text == "تاك للزوجات" or text == "الزوجات" then
  local zwgat_list = Redis:smembers(TheNero..msg_chat_id.."zwgat:")
...
if text == "طلاق" or text == "تنزيل زوجتي" or text == "تزيل زوجي" and msg.reply_to_message_id ~= 0 then
  ...
  if Redis:sismember(TheNero..msg_chat_id.."zwgat:",Message_Reply.sender.user_id) then
    Redis:srem(TheNero..msg_chat_id.."zwgat:",Message_Reply.sender.user_id)
    Redis:sadd(TheNero..msg_chat_id.."mutlqat:",Message_Reply.sender.user_id) 
    local rd_tmtlaq = {
      "تم طلاقكم للاسف",
      "تم الطلاق بسبب سحر ام عباس 🙂💔.",
      "تم الطلاق بسبب الاخ ميعرف شي 😹🏃‍♀️.",
      "تم الطلاق بسبب شيماء تدخلت بيناتهم ",
      "تم الطلاق راسلو توفي يرجعكم 😹🏃‍♀️."
    }
...
if text == "تاك للمطلقات" or text == "المطلقات" then
  local mutlqat_list = Redis:smembers(TheNero..msg_chat_id.."mutlqat:")
...
keyboard.inline_keyboard = {
{
{text = ' ❲ S𝘰𝘶𝘳𝘤𝘦 S𝘯𝘢𝘱 ❳ ',url="https://t.me/iinzzz"},{text = '  ❲ 𝘦𝘹𝘱𝘭𝘢𝘯𝘢𝘵𝘪𝘰𝘯𝘴 ❳ ',url="https://t.me/BBI9B"}
},
{
{text = '❲ 𝖼𝗈𝖽𝖾𝗋 ❳',url="https://t.me/RFRFF"}
},
...
LuaTele.sendText(msg_chat_id,msg_id,"‹ : انت توفي مطور السورس يقلبي🌚💘","md",true)
...
Redis:del(TheNero.."Nero:Status:joinet"..msg_chat_id) 
...
Redis:set(TheNero.."Nero:Status:joinet"..msg_chat_id,true) 
...
if TextMsg == 'الرابط' then
Redis:del(TheNero.."Nero:Status:Link"..msg_chat_id) 
return LuaTele.sendText(msg_chat_id,msg_id,"⌔ : تم تعطيل الرابط ","md",true)
end
if TextMsg == 'الترحيب' then
Redis:del(TheNero.."Nero:Status:Welcome"..msg_chat_id) 
...
Redis:del(TheNero.."Nero:Status:Id"..msg_chat_id) 
...
Redis:del(TheNero.."Nero:Status:IdPhoto"..msg_chat_id) 
...
Redis:del(TheNero.."Nero:Status:Reply"..msg_chat_id) 
...
Redis:del(TheNero.."Nero:Status:ReplySudo"..msg_chat_id) 
...
Redis:del(TheNero.."Nero:Status:BanId"..msg_chat_id) 
...
Redis:del(TheNero.."Nero:Status:SetId"..msg_chat_id) 
return LuaTele.sendText(msg_chat_id,msg_id,"⌔ : تم تعطيل الرفع ","md",true)
end
if TextMsg == 'الالعاب' then
Redis:del(TheNero.."Nero:Status:Games"..msg_chat_id) 
return LuaTele.sendText(msg_chat_id,msg_id,"⌔ : تم تعطيل الالعاب ","md",true)
end
if TextMsg == 'اطردني' then
Redis:del(TheNero.."Nero:Status:KickMe"..msg_chat_id) 
...
Redis:del(TheNero.."Nero:BotFree") 
...
Redis:del(TheNero.."Nero:TwaslBot") 
...
if Redis:sismember(TheNero.."Nero:BanAll:Groups",UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"⌔ : تم حظره عام من المجموعات مسبقا ").Reply,"md",true)  
else
Redis:sadd(TheNero.."Nero:BanAll:Groups",UserId_Info.id) 
...
if not Redis:sismember(TheNero.."Nero:BanAll:Groups",UserId_Info.id) then
...
Redis:srem(TheNero.."Nero:BanAll:Groups",UserId_Info.id) 
...
if not msg.Originators and not Redis:get(TheNero.."Nero:Status:BanId"..msg_chat_id) then
...
if Redis:sismember(TheNero.."Nero:BanGroup:Group"..msg_chat_id,UserId_Info.id) then
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {
{
...
Redis:sadd(TheNero.."Nero:BanGroup:Group"..msg_chat_id,UserId_Info.id) 
LuaTele.setChatMemberStatus(msg.chat_id,UserId_Info.id,'banned',0)
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {
...
if not Redis:sismember(TheNero.."Nero:BanGroup:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"⌔ : تم الغاء حظره من المجموعه مسبقا ").Reply,"md",true)  
else
Redis:srem(TheNero.."Nero:BanGroup:Group"..msg_chat_id,UserId_Info.id) 
LuaTele.setChatMemberStatus(msg.chat_id,UserId_Info.id,'restricted',{1,1,1,1,1,1,1,1,1})
...
if Redis:sismember(TheNero.."Nero:SilentGroup:Group"..msg_chat_id,UserId_Info.id) then
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {
{
...
Redis:sadd(TheNero.."Nero:SilentGroup:Group"..msg_chat_id,UserId_Info.id) 
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {
{
...
if not Redis:sismember(TheNero.."Nero:SilentGroup:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"⌔ : تم الغاء كتمه من المجموعه ").Reply,"md",true)  
else
Redis:srem(TheNero.."Nero:SilentGroup:Group"..msg_chat_id,UserId_Info.id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"⌔ : تم الغاء كتمه من المجموعه ").Reply,"md",true)  
end
end
...
if Redis:sismember(TheNero.."Nero:BanAll:Groups",Message_Reply.sender.user_id) then
...
Redis:sadd(TheNero.."Nero:BanAll:Groups",Message_Reply.sender.user_id) 
...
if not Redis:sismember(TheNero.."Nero:BanAll:Groups",Message_Reply.sender.user_id) then
...
Redis:srem(TheNero.."Nero:BanAll:Groups",Message_Reply.sender.user_id) 
...
if Redis:sismember(TheNero.."Nero:BanGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(TheNero.."Nero:BanGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) 
LuaTele.setChatMemberStatus(msg.chat_id,Message_Reply.sender.user_id,'banned',0)
...
if not Redis:sismember(TheNero.."Nero:BanGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(TheNero.."Nero:BanGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) 
LuaTele.setChatMemberStatus(msg.chat_id,Message_Reply.sender.user_id,'restricted',{1,1,1,1,1,1,1,1,1})
...
if Redis:sismember(TheNero.."Nero:SilentGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(TheNero.."Nero:SilentGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(TheNero.."Nero:SilentGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(TheNero.."Nero:SilentGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"⌔ : تم الغاء كتمه من المجموعه ").Reply,"md",true)  
end
end
...
if Redis:sismember(TheNero.."Nero:BanGroup:Group"..msg_chat_id,UserId) then
...
Redis:sadd(TheNero.."Nero:BanGroup:Group"..msg_chat_id,UserId) 
LuaTele.setChatMemberStatus(msg.chat_id,UserId,'banned',0)
...
if not Redis:sismember(TheNero.."Nero:BanGroup:Group"..msg_chat_id,UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"⌔ : تم الغاء حظره من المجموعه مسبقا ").Reply,"md",true)  
else
Redis:srem(TheNero.."Nero:BanGroup:Group"..msg_chat_id,UserId) 
LuaTele.setChatMemberStatus(msg.chat_id,UserId,'restricted',{1,1,1,1,1,1,1,1,1})
...
if Redis:sismember(TheNero.."Nero:SilentGroup:Group"..msg_chat_id,UserId) then
...
Redis:sadd(TheNero.."Nero:SilentGroup:Group"..msg_chat_id,UserId) 
...
if not Redis:sismember(TheNero.."Nero:SilentGroup:Group"..msg_chat_id,UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"⌔ : تم الغاء كتمه من المجموعه ").Reply,"md",true)  
else
Redis:srem(TheNero.."Nero:SilentGroup:Group"..msg_chat_id,UserId) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"⌔ : تم الغاء كتمه من المجموعه ").Reply,"md",true)  
end
end
...
if not Redis:get(TheNero.."Nero:Status:KickMe"..msg_chat_id) then
...
Redis:sadd(TheNero.."Nero:Addictive:Group"..msg_chat_id,v.member_id.user_id) 
y = y + 1
end
end
end
...
if not msg.ControllerBot and not Redis:set(TheNero.."Nero:LeftBot") then
...
Redis:set(TheNero.."Nero:Lock:text"..msg_chat_id,true) 
...
Redis:set(TheNero.."Nero:Lock:AddMempar"..msg_chat_id,"kick")  
...
Redis:set(TheNero.."Nero:Lock:Join"..msg_chat_id,"kick")  
...
Redis:set(TheNero.."Nero:Lock:Bot:kick"..msg_chat_id,"del")  
...
Redis:set(TheNero.."Nero:Lock:Bot:kick"..msg_chat_id,"kick")  
...
Redis:set(TheNero.."Nero:Lock:tagservr"..msg_chat_id,true)  
...
Redis:set(TheNero.."Nero:lockpin"..msg_chat_id,(LuaTele.getChatPinnedMessage(msg_chat_id).id or true)) 
...
Redis:set(TheNero.."lockalllll"..msg_chat_id,"off")
...
Redis:set(TheNero.."lockalllll"..msg_chat_id,"on")
...
Redis:set(TheNero.."Nero:Lock:edit"..msg_chat_id,true) 
...
Redis:set(TheNero.."Nero:Lock:tagservrbot"..msg_chat_id,true)   
list ={"Lock:Bot:kick","Lock:User:Name","Lock:hashtak","Lock:Cmd","Lock:Link","Lock:forward","Lock:Keyboard","Lock:geam","Lock:Photo","Lock:Animation","Lock:Video","Lock:Audio","Lock:vico","Lock:Sticker","Lock:Document","Lock:Unsupported","Lock:Markdaun","Lock:Contact","Lock:Spam"}
for i,lock in pairs(list) do 
Redis:set(TheNero..'Nero:'..lock..msg_chat_id,"del")    
end
...
Redis:del(TheNero.."Nero:Lock:AddMempar"..msg_chat_id)  
...
Redis:del(TheNero.."Nero:Lock:text"..msg_chat_id)  
...
Redis:del(TheNero.."Nero:Lock:Join"..msg_chat_id)  
...
Redis:del(TheNero.."Nero:Lock:Bot:kick"..msg_chat_id)  
...
Redis:del(TheNero.."Nero:Lock:tagservr"..msg_chat_id)  
...
Redis:del(TheNero.."Nero:lockpin"..msg_chat_id)  
...
Redis:del(TheNero.."Nero:Lock:edit"..msg_chat_id) 
...
Redis:del(TheNero.."Nero:Lock:tagservrbot"..msg_chat_id)   
list ={"Lock:Bot:kick","Lock:User:Name","Lock:hashtak","Lock:Cmd","Lock:Link","Lock:forward","Lock:Keyboard","Lock:geam","Lock:Photo","Lock:Animation","Lock:Video","Lock:Audio","Lock:vico","Lock:Sticker","Lock:Document","Lock:Unsupported","Lock:Markdaun","Lock:Contact","Lock:Spam"}
for i,lock in pairs(list) do 
Redis:del(TheNero..'Nero:'..lock..msg_chat_id)    
end
...
Redis:hset(TheNero.."Nero:Spam:Group:User"..msg_chat_id ,"Spam:User","del")  
...
Redis:hset(TheNero.."Nero:Spam:Group:User"..msg_chat_id ,"Spam:User","keed")  
...
Redis:hset(TheNero.."Nero:Spam:Group:User"..msg_chat_id ,"Spam:User","mute")  
...
Redis:hset(TheNero.."Nero:Spam:Group:User"..msg_chat_id ,"Spam:User","kick")  
...
Redis:hdel(TheNero.."Nero:Spam:Group:User"..msg_chat_id ,"Spam:User")  
...
Redis:set(TheNero.."Nero:Lock:Link"..msg_chat_id,"del")  
...
Redis:set(TheNero.."Nero:Lock:Link"..msg_chat_id,"ked")  
...
Redis:set(TheNero.."Nero:Lock:Link"..msg_chat_id,"ktm")  
...
Redis:set(TheNero.."Nero:Lock:Link"..msg_chat_id,"kick")  
...
Redis:del(TheNero.."Nero:Lock:Link"..msg_chat_id)  
...
Redis:set(TheNero.."Nero:Lock:User:Name"..msg_chat_id,"del")  
...
Redis:set(TheNero.."Nero:Lock:User:Name"..msg_chat_id,"ked")  
...
Redis:set(TheNero.."Nero:Lock:User:Name"..msg_chat_id,"ktm")  
...
Redis:set(TheNero.."Nero:Lock:User:Name"..msg_chat_id,"kick")  
...
Redis:del(TheNero.."Nero:Lock:User:Name"..msg_chat_id)  
...
Redis:set(TheNero.."Nero:Lock:hashtak"..msg_chat_id,"del")  
...
Redis:set(TheNero.."Nero:Lock:hashtak"..msg_chat_id,"ked")  
...
Redis:set(TheNero.."Nero:Lock:hashtak"..msg_chat_id,"ktm")  
...
Redis:set(TheNero.."Nero:Lock:hashtak"..msg_chat_id,"kick")  
...
Redis:del(TheNero.."Nero:Lock:hashtak"..msg_chat_id)  
...
Redis:set(TheNero.."Nero:Lock:Cmd"..msg_chat_id,"del")  
...
Redis:set(TheNero.."Nero:Lock:Cmd"..msg_chat_id,"ked")  
...
Redis:set(TheNero.."Nero:Lock:Cmd"..msg_chat_id,"ktm")  
...
Redis:set(TheNero.."Nero:Lock:Cmd"..msg_chat_id,"kick")  
...
Redis:del(TheNero.."Nero:Lock:Cmd"..msg_chat_id)  
...
Redis:set(TheNero.."Nero:Lock:Photo"..msg_chat_id,"del")  
...
Redis:set(TheNero.."Nero:Lock:Photo"..msg_chat_id,"ked")  
...
Redis:set(TheNero.."Nero:Lock:Photo"..msg_chat_id,"ktm")  
...
Redis:set(TheNero.."Nero:Lock:Photo"..msg_chat_id,"kick")  
...
Redis:set(TheNero.."Nero:Lock:phshar"..msg_chat_id,true) 
...
Redis:set(TheNero..'lock:Fars'..msg.chat_id,true) 
...
Redis:del(TheNero.."Nero:Lock:phshar"..msg_chat_id)  
...
Redis:del(TheNero..'lock:Fars'..msg.chat_id) 
...
Redis:del(TheNero.."Nero:Lock:Photo"..msg_chat_id)  
...
Redis:set(TheNero.."Nero:Lock:Video"..msg_chat_id,"del")  
...
Redis:set(TheNero.."Nero:Lock:Video"..msg_chat_id,"ked")  
...
Redis:set(TheNero.."Nero:Lock:Video"..msg_chat_id,"ktm")  
...
Redis:set(TheNero.."Nero:Lock:Video"..msg_chat_id,"kick")  
...
Redis:del(TheNero.."Nero:Lock:Video"..msg_chat_id)  
...
Redis:set(TheNero.."Nero:Lock:Animation"..msg_chat_id,"del")  
...
Redis:set(TheNero.."Nero:Lock:Animation"..msg_chat_id,"ked")  
...
Redis:set(TheNero.."Nero:Lock:Animation"..msg_chat_id,"ktm")  
...
Redis:set(TheNero.."Nero:Lock:Animation"..msg_chat_id,"kick")  
...
Redis:del(TheNero.."Nero:Lock:Animation"..msg_chat_id)  
...
Redis:set(TheNero.."Nero:Lock:geam"..msg_chat_id,"del")  
...
Redis:set(TheNero.."Nero:Lock:geam"..msg_chat_id,"ked")  
...
Redis:set(TheNero.."Nero:Lock:geam"..msg_chat_id,"ktm")  
...
Redis:set(TheNero.."Nero:Lock:geam"..msg_chat_id,"kick")  
...
Redis:del(TheNero.."Nero:Lock:geam"..msg_chat_id)  
...
Redis:set(TheNero.."Nero:Lock:Audio"..msg_chat_id,"del")  
...
Redis:set(TheNero.."Nero:Lock:Audio"..msg_chat_id,"ked")  
...
Redis:set(TheNero.."Nero:Lock:Audio"..msg_chat_id,"ktm")  
...
Redis:set(TheNero.."Nero:Lock:Audio"..msg_chat_id,"kick")  
...
Redis:del(TheNero.."Nero:Lock:Audio"..msg_chat_id)  
...
Redis:set(TheNero.."Nero:Lock:vico"..msg_chat_id,"del")  
...
Redis:set(TheNero.."Nero:Lock:vico"..msg_chat_id,"ked")  
...
Redis:set(TheNero.."Nero:Lock:vico"..msg_chat_id,"ktm")  
...
Redis:set(TheNero.."Nero:Lock:vico"..msg_chat_id,"kick")  
...
Redis:del(TheNero.."Nero:Lock:vico"..msg_chat_id)  
...
Redis:set(TheNero.."Nero:Lock:Keyboard"..msg_chat_id,"del")  
...
Redis:set(TheNero.."Nero:Lock:Keyboard"..msg_chat_id,"ked")  
...
Redis:set(TheNero.."Nero:Lock:Keyboard"..msg_chat_id,"ktm")  
...
Redis:set(TheNero.."Nero:Lock:Keyboard"..msg_chat_id,"kick")  
...
Redis:del(TheNero.."Nero:Lock:Keyboard"..msg_chat_id)  
...
Redis:set(TheNero.."Nero:Lock:Sticker"..msg_chat_id,"del")  
...
Redis:set(TheNero.."Nero:Lock:Sticker"..msg_chat_id,"ked")  
...
Redis:set(TheNero.."Nero:Lock:Sticker"..msg_chat_id,"ktm")  
...
Redis:set(TheNero.."Nero:Lock:Sticker"..msg_chat_id,"kick")  
...
Redis:del(TheNero.."Nero:Lock:Sticker"..msg_chat_id)  
...
Redis:set(TheNero.."Nero:Lock:forward"..msg_chat_id,"del")  
...
Redis:set(TheNero.."Nero:Lock:forward"..msg_chat_id,"ked")  
...
Redis:set(TheNero.."Nero:Lock:forward"..msg_chat_id,"ktm")  
...
Redis:set(TheNero.."Nero:Lock:forward"..msg_chat_id,"kick")  
...
Redis:del(TheNero.."Nero:Lock:forward"..msg_chat_id)  
...
Redis:set(TheNero.."Nero:Lock:Document"..msg_chat_id,"del")  
...
Redis:set(TheNero.."Nero:Lock:Document"..msg_chat_id,"ked")  
...
Redis:set(TheNero.."Nero:Lock:Document"..msg_chat_id,"ktm")  
...
Redis:set(TheNero.."Nero:Lock:Document"..msg_chat_id,"kick")  
...
Redis:del(TheNero.."Nero:Lock:Document"..msg_chat_id)  
...
Redis:set(TheNero.."Nero:Lock:Unsupported"..msg_chat_id,"del")  
...
Redis:set(TheNero.."Nero:Lock:Unsupported"..msg_chat_id,"ked")  
...
Redis:set(TheNero.."Nero:Lock:Unsupported"..msg_chat_id,"ktm")  
...
Redis:set(TheNero.."Nero:Lock:Unsupported"..msg_chat_id,"kick")  
...
Redis:del(TheNero.."Nero:Lock:Unsupported"..msg_chat_id)  
...
Redis:set(TheNero.."Nero:Lock:Markdaun"..msg_chat_id,"del")  
...
Redis:set(TheNero.."Nero:Lock:Markdaun"..msg_chat_id,"ked")  
...
Redis:set(TheNero.."Nero:Lock:Markdaun"..msg_chat_id,"ktm")  
...
Redis:set(TheNero.."Nero:Lock:Markdaun"..msg_chat_id,"kick")  
...
Redis:del(TheNero.."Nero:Lock:Markdaun"..msg_chat_id)  
...
Redis:set(TheNero.."Nero:Lock:Contact"..msg_chat_id,"del")  
...
Redis:set(TheNero.."Nero:Lock:Contact"..msg_chat_id,"ked")  
...
Redis:set(TheNero.."Nero:Lock:Contact"..msg_chat_id,"ktm")  
...
Redis:set(TheNero.."Nero:Lock:Contact"..msg_chat_id,"kick")  
...
Redis:del(TheNero.."Nero:Lock:Contact"..msg_chat_id)  
...
Redis:set(TheNero.."Nero:Lock:Spam"..msg_chat_id,"del")  
...
Redis:set(TheNero.."Nero:Lock:Spam"..msg_chat_id,"ked")  
...
Redis:set(TheNero.."Nero:Lock:Spam"..msg_chat_id,"ktm")  
...
Redis:set(TheNero.."Nero:Lock:Spam"..msg_chat_id,"kick")  
...
Redis:del(TheNero.."Nero:Lock:Spam"..msg_chat_id)  
...
Redis:set(TheNero.."Nero:Lock:Inlen"..msg_chat_id,"del")  
...
Redis:set(TheNero.."Nero:Lock:Inlen"..msg_chat_id,"ked")  
...
Redis:set(TheNero.."Nero:Lock:Inlen"..msg_chat_id,"ktm")  
...
Redis:set(TheNero.."Nero:Lock:Inlen"..msg_chat_id,"kick")  
...
Redis:del(TheNero.."Nero:Lock:Inlen"..msg_chat_id)  
...
Redis:setex(TheNero.."Nero:Set:Link"..msg_chat_id..""..msg.sender.user_id,120,true) 
...
Redis:del(TheNero.."Nero:Group:Link"..msg_chat_id) 
return LuaTele.sendText(msg_chat_id,msg_id,"⌔ : تم مسح الرابط ","md",true)             
end
if text == "الرابط" then
if not Redis:get(TheNero.."Nero:Status:Link"..msg_chat_id) then
return LuaTele.sendText(msg_chat_id,msg_id,"⌔ : تم تعطيل جلب الرابط من قبل الادمنيه","md",true)
end 
local Get_Chat = LuaTele.getChat(msg_chat_id)
local GetLink = Redis:get(TheNero.."Nero:Group:Link"..msg_chat_id) 
if GetLink then
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {
...
Redis:setex(TheNero.."Tshake:Welcome:Group" .. msg_chat_id .. "" .. msg.sender.user_id, 120, true)  
...
if not Redis:get(TheNero.."Nero:Status:Welcome"..msg_chat_id) then
...
Redis:del(TheNero.."Nero:Welcome:Group"..msg_chat_id) 
...
Redis:setex(TheNero.."Nero:Set:Rules:" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
...
Redis:del(TheNero.."Nero:Group:Rules"..msg_chat_id) 
return LuaTele.sendText(msg_chat_id,msg_id,"⌔ : تم ازالة قوانين المجموعه","md",true)    
end
if text == "القوانين" then 
local Rules = Redis:get(TheNero.."Nero:Group:Rules" .. msg_chat_id)   
if Rules then     
...
Redis:setex(TheNero.."Nero:Set:Description:" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
...
Redis:set(TheNero.."Nero:Chat:Photo"..msg_chat_id..":"..msg.sender.user_id,true) 
...
local list = Redis:smembers(TheNero.."Nero:List:Filter"..msg_chat_id)  
if #list == 0 then  
...
v = v:gsub('animation:',"") 
v = v:gsub('text:',"") 
Redis:del(TheNero.."Nero:Filter:Group:"..v..msg_chat_id)  
Redis:srem(TheNero.."Nero:List:Filter"..msg_chat_id,v)  
end  
...
v = v:gsub('animation:',"") 
v = v:gsub('text:',"") 
local Text_Filter = Redis:get(TheNero.."Nero:Filter:Group:"..v..msg_chat_id)   
...
Redis:set(TheNero..'Nero:FilterText'..msg_chat_id..':'..msg.sender.user_id,'true')
...
Redis:set(TheNero..'Nero:FilterText'..msg_chat_id..':'..msg.sender.user_id,'DelFilter')
return LuaTele.sendText(msg_chat_id,msg_id,'\n*⌔ : ارسل الان { ملصق ,متحركه ,صوره ,رساله } *',"md",true)  
end
...
Redis:set(TheNero.."Nero:Command:Reids:Group"..msg_chat_id..":"..msg.sender.user_id,"true") 
...
Redis:set(TheNero.."Nero:Command:Reids:Group:Del"..msg_chat_id..":"..msg.sender.user_id,"true") 
...
local list = Redis:smembers(TheNero.."Nero:Command:List:Group"..msg_chat_id)
for k,v in pairs(list) do
Redis:del(TheNero.."Nero:Get:Reides:Commands:Group"..msg_chat_id..":"..v)
Redis:del(TheNero.."Nero:Command:List:Group"..msg_chat_id)
end
...
for k,v in pairs(list) do
Commands = Redis:get(TheNero.."Nero:Get:Reides:Commands:Group"..msg_chat_id..":"..v)
if Commands then 
...
if Redis:get(TheNero.."Nero:Status:Link"..msg.chat_id) then
Statuslink = '❬ ✔️ ❭' else Statuslink = '❬ ❌ ❭'
end
if Redis:get(TheNero.."Nero:Status:Welcome"..msg.chat_id) then
StatusWelcome = '❬ ✔️ ❭' else StatusWelcome = '❬ ❌ ❭'
end
if Redis:get(TheNero.."Nero:Status:Id"..msg.chat_id) then
StatusId = '❬ ✔️ ❭' else StatusId = '❬ ❌ ❭'
end
if Redis:get(TheNero.."Nero:Status:IdPhoto"..msg.chat_id) then
StatusIdPhoto = '❬ ✔️ ❭' else StatusIdPhoto = '❬ ❌ ❭'
end
if Redis:get(TheNero.."Nero:Status:Reply"..msg.chat_id) then
StatusReply = '❬ ✔️ ❭' else StatusReply = '❬ ❌ ❭'
end
if Redis:get(TheNero.."Nero:Status:ReplySudo"..msg.chat_id) then
StatusReplySudo = '❬ ✔️ ❭' else StatusReplySudo = '❬ ❌ ❭'
end
if Redis:get(TheNero.."Nero:Status:BanId"..msg.chat_id)  then
StatusBanId = '❬ ✔️ ❭' else StatusBanId = '❬ ❌ ❭'
end
if Redis:get(TheNero.."Nero:Status:SetId"..msg.chat_id) then
StatusSetId = '❬ ✔️ ❭' else StatusSetId = '❬ ❌ ❭'
end
if Redis:get(TheNero.."Nero:Status:Games"..msg.chat_id) then
StatusGames = '❬ ✔️ ❭' else StatusGames = '❬ ❌ ❭'
end
if Redis:get(TheNero.."Nero:Status:KickMe"..msg.chat_id) then
Statuskickme = '❬ ✔️ ❭' else Statuskickme = '❬ ❌ ❭'
end
if Redis:get(TheNero.."Nero:Status:AddMe"..msg.chat_id) then
...
Rink = 1
elseif Redis:sismember(TheNero.."Nero:Developers:Groups",Message_Reply.sender.user_id)  then
Rink = 2
elseif Redis:sismember(TheNero.."Nero:TheBasics:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 3
elseif Redis:sismember(TheNero.."Nero:Originators:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 4
elseif Redis:sismember(TheNero.."Nero:Managers:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 5
elseif Redis:sismember(TheNero.."Nero:Addictive:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 6
elseif Redis:sismember(TheNero.."Nero:Distinguished:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 7
else
Rink = 8
end
...
Rink = 1
elseif Redis:sismember(TheNero.."Nero:Developers:Groups",UserId_Info.id)  then
Rink = 2
elseif Redis:sismember(TheNero.."Nero:TheBasics:Group"..msg_chat_id, UserId_Info.id) then
Rink = 3
elseif Redis:sismember(TheNero.."Nero:Originators:Group"..msg_chat_id, UserId_Info.id) then
Rink = 4
elseif Redis:sismember(TheNero.."Nero:Managers:Group"..msg_chat_id, UserId_Info.id) then
Rink = 5
elseif Redis:sismember(TheNero.."Nero:Addictive:Group"..msg_chat_id, UserId_Info.id) then
Rink = 6
elseif Redis:sismember(TheNero.."Nero:Distinguished:Group"..msg_chat_id, UserId_Info.id) then
Rink = 7
else
Rink = 8
end
...
Redis:del(TheNero..'Nero:Num:Message:User'..msg.chat_id..':'..msg.sender.user_id)
LuaTele.sendText(msg_chat_id,msg_id,'⌔ : تم مسح جميع رسائلك ',"md",true)  
elseif text == 'مسح سحكاتي' or text == 'مسح تعديلاتي' then
Redis:del(TheNero..'Nero:Num:Message:Edit'..msg.chat_id..':'..msg.sender.user_id)
LuaTele.sendText(msg_chat_id,msg_id,'⌔ : تم مسح جميع تعديلاتك ',"md",true)  
elseif text == 'مسح جهاتي' then
Redis:del(TheNero..'Nero:Num:Add:Memp'..msg.chat_id..':'..msg.sender.user_id)
LuaTele.sendText(msg_chat_id,msg_id,'⌔ : تم مسح جميع جهاتك المضافه ',"md",true)  
elseif text == 'رسائلي' then
LuaTele.sendText(msg_chat_id,msg_id,'⌔ : عدد رسائلك هنا *~ '..(Redis:get(TheNero..'Nero:Num:Message:User'..msg.chat_id..':'..msg.sender.user_id) or 1)..'*',"md",true)  
elseif text == 'سحكاتي' or text == 'تعديلاتي' then
LuaTele.sendText(msg_chat_id,msg_id,'⌔ : عدد التعديلات هنا *~ '..(Redis:get(TheNero..'Nero:Num:Message:Edit'..msg.chat_id..msg.sender.user_id) or 0)..'*',"md",true)  
elseif text == 'جهاتي' then
LuaTele.sendText(msg_chat_id,msg_id,'⌔ : عدد جهاتك المضافه هنا *~ '..(Redis:get(TheNero.."Nero:Num:Add:Memp"..msg.chat_id..":"..msg.sender.user_id) or 0)..'*',"md",true)  
...
Redis:setex(TheNero.."Nero:Redis:Id:Group"..msg.chat_id..""..msg.sender.user_id,240,true)  
return LuaTele.sendText(msg_chat_id,msg_id,[[
⌔ : ارسل الان النص
⌔ : يمكنك اضافه :
...
Redis:del(TheNero.."Nero:Set:Id:Group"..msg.chat_id)
...
Redis:del(TheNero.."Nero:DevelopersQ:Groups") 
...
Redis:del(TheNero.."Nero:Developers:Groups") 
...
Redis:del(TheNero.."Nero:TheBasicsQ:Group"..msg_chat_id) 
...
Redis:del(TheNero.."Nero:TheBasics:Group"..msg_chat_id) 
...
Redis:del(TheNero.."Nero:Originators:Group"..msg_chat_id) 
...
Redis:del(TheNero.."Nero:Managers:Group"..msg_chat_id) 
...
Redis:del(TheNero.."Nero:Addictive:Group"..msg_chat_id) 
...
Redis:del(TheNero.."Nero:Distinguished:Group"..msg_chat_id) 
...
Redis:del(TheNero.."Nero:BanAll:Groups") 
...
Redis:del(TheNero.."Nero:BanGroup:Group"..msg_chat_id) 
...
Redis:del(TheNero.."Nero:SilentGroup:Group"..msg_chat_id) 
...
local list = Redis:smembers(TheNero.."Nero:List:Manager"..msg_chat_id.."")
for k,v in pairs(list) do
Redis:del(TheNero.."Nero:Add:Rd:Manager:Gif"..v..msg_chat_id)   
Redis:del(TheNero.."Nero:Add:Rd:Manager:Vico"..v..msg_chat_id)   
Redis:del(TheNero.."Nero:Add:Rd:Manager:Stekrs"..v..msg_chat_id)     
Redis:del(TheNero.."Nero:Add:Rd:Manager:Text"..v..msg_chat_id)   
Redis:del(TheNero.."Nero:Add:Rd:Manager:Photo"..v..msg_chat_id)
Redis:del(TheNero.."Nero:Add:Rd:Manager:Video"..v..msg_chat_id)
Redis:del(TheNero.."Nero:Add:Rd:Manager:File"..v..msg_chat_id)
Redis:del(TheNero.."Nero:Add:Rd:Manager:video_note"..v..msg_chat_id)
Redis:del(TheNero.."Nero:Add:Rd:Manager:Audio"..v..msg_chat_id)
Redis:del(TheNero.."Nero:List:Manager"..msg_chat_id)
end
...
for k,v in pairs(list) do
if Redis:get(TheNero.."Nero:Add:Rd:Manager:Gif"..v..msg_chat_id) then
db = "متحركه 🎭"
elseif Redis:get(TheNero.."Nero:Add:Rd:Manager:Vico"..v..msg_chat_id) then
db = "بصمه 📢"
elseif Redis:get(TheNero.."Nero:Add:Rd:Manager:Stekrs"..v..msg_chat_id) then
db = "ملصق 🃏"
elseif Redis:get(TheNero.."Nero:Add:Rd:Manager:Text"..v..msg_chat_id) then
db = "رساله ✉"
elseif Redis:get(TheNero.."Nero:Add:Rd:Manager:Photo"..v..msg_chat_id) then
db = "صوره 🎇"
elseif Redis:get(TheNero.."Nero:Add:Rd:Manager:Video"..v..msg_chat_id) then
db = "فيديو 📹"
elseif Redis:get(TheNero.."Nero:Add:Rd:Manager:File"..v..msg_chat_id) then
db = "ملف ⌔ : "
elseif Redis:get(TheNero.."Nero:Add:Rd:Manager:Audio"..v..msg_chat_id) then
db = "اغنيه 🎵"
elseif Redis:get(TheNero.."Nero:Add:Rd:Manager:video_note"..v..msg_chat_id) then
db = "بصمه فيديو 🎥"
end
text = text..""..k.." » {"..v.."} » {"..db.."}\n"
end
...
Redis:set(TheNero.."Nero:Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id,true)
...
Redis:set(TheNero.."Nero:Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id,"true2")
...
local list = Redis:smembers(TheNero.."Nero:List:Rd:Sudo")
for k,v in pairs(list) do
Redis:del(TheNero.."Nero:Add:Rd:Sudo:Gif"..v)   
Redis:del(TheNero.."Nero:Add:Rd:Sudo:vico"..v)   
Redis:del(TheNero.."Nero:Add:Rd:Sudo:stekr"..v)     
Redis:del(TheNero.."Nero:Add:Rd:Sudo:Text"..v)   
Redis:del(TheNero.."Nero:Add:Rd:Sudo:Photo"..v)
Redis:del(TheNero.."Nero:Add:Rd:Sudo:Video"..v)
Redis:del(TheNero.."Nero:Add:Rd:Sudo:File"..v)
Redis:del(TheNero.."Nero:Add:Rd:Sudo:Audio"..v)
Redis:del(TheNero.."Nero:Add:Rd:Sudo:video_note"..v)
Redis:del(TheNero.."Nero:List:Rd:Sudo")
end
...
text = "\n📝︙قائمة ردود المطور \n⋆┄┄─┄─┄─┄┄─┄─┄┄⋆\n"
for k,v in pairs(list) do
if Redis:get(TheNero.."Nero:Add:Rd:Sudo:Gif"..v) then
db = "متحركه 🎭"
elseif Redis:get(TheNero.."Nero:Add:Rd:Sudo:vico"..v) then
db = "بصمه 📢"
elseif Redis:get(TheNero.."Nero:Add:Rd:Sudo:stekr"..v) then
db = "ملصق 🃏"
elseif Redis:get(TheNero.."Nero:Add:Rd:Sudo:Text"..v) then
db = "رساله ✉"
elseif Redis:get(TheNero.."Nero:Add:Rd:Sudo:Photo"..v) then
db = "صوره 🎇"
elseif Redis:get(TheNero.."Nero:Add:Rd:Sudo:Video"..v) then
db = "فيديو 📹"
elseif Redis:get(TheNero.."Nero:Add:Rd:Sudo:File"..v) then
db = "ملف ⌔ : "
elseif Redis:get(TheNero.."Nero:Add:Rd:Sudo:Audio"..v) then
db = "اغنيه 🎵"
elseif Redis:get(TheNero.."Nero:Add:Rd:Sudo:video_note"..v) then
db = "بصمه فيديو 🎥"
end
text = text..""..k.." » {"..v.."} » {"..db.."}\n"
end
...
Redis:set(TheNero.."Nero:Set:Rd"..msg.sender.user_id..":"..msg_chat_id,true)
...
Redis:set(TheNero.."Nero:Set:On"..msg.sender.user_id..":"..msg_chat_id,true)
...
Redis:setex(TheNero.."Nero:Broadcasting:Users" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
LuaTele.sendText(msg_chat_id,msg_id,[[
⌔ : ارسل لي سواء كان 
❨ ملف ⌔ : ملصق ⌔ : متحركه ⌔ : صوره
 ⌔ : فيديو ⌔ : بصمه الفيديو ⌔ : بصمه ⌔ : صوت ⌔ : رساله ❩
...
Redis:setex(TheNero.."Nero:Broadcasting:Groups" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
LuaTele.sendText(msg_chat_id,msg_id,[[
⌔ : ارسل لي سواء كان 
❨ ملف ⌔ : ملصق ⌔ : متحركه ⌔ : صوره
 ⌔ : فيديو ⌔ : بصمه الفيديو ⌔ : بصمه ⌔ : صوت ⌔ : رساله ❩
...
Redis:setex(TheNero.."Nero:Broadcasting:Groups:Pin" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
LuaTele.sendText(msg_chat_id,msg_id,[[
⌔ : ارسل لي سواء كان 
❨ ملف ⌔ : ملصق ⌔ : متحركه ⌔ : صوره
 ⌔ : فيديو ⌔ : بصمه الفيديو ⌔ : بصمه ⌔ : صوت ⌔ : رساله ❩
...
Redis:setex(TheNero.."Nero:Broadcasting:Groups:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
...
Redis:setex(TheNero.."Nero:Broadcasting:Users:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
...
Redis:set(TheNero..'Nero:GetTexting:DevTheNero'..msg_chat_id..':'..msg.sender.user_id,true)
...
Redis:del(TheNero..'Nero:Texting:DevTheNero')
...
Redis:setex(TheNero.."Nero:Change:Name:Bot"..msg.sender.user_id,300,true) 
...
Redis:del(TheNero.."Nero:Name:Bot") 
return LuaTele.sendText(msg_chat_id,msg_id,"⌔ : تم حذف اسم البوت ","md",true)   
end
if text == (Redis:get(TheNero.."Nero:Name:Bot") or "سناب") then
local NamesBot = (Redis:get(TheNero.."Nero:Name:Bot") or "سناب")
local NameBots = {
"يروح "..NamesBot.. " كول؟",
"انا "..NamesBot.. " القميل",
"هاعمري",
...
keyboard.inline_keyboard = {
{
{text = NamesBots, url = 'https://t.me/iinzzz'}, 
},
{
...
if text == (Redis:get(TheNero.."Nero:Name:Bot") or "آيلاند") then
local photo = LuaTele.getUserProfilePhotos(TheNero)
local UserInfo = LuaTele.getUser(TheNero)
for Name_User in string.gmatch(UserInfo.first_name, "[^%s]+" ) do
UserInfo.first_name = Name_User
...
local NamesBot = (Redis:get(TheNero.."Nero:Name:Bot") or "آيلاند")
local BotName = {
"يروح "..NamesBot.. " كول؟",
"انا "..NamesBot.. " القميل",
"هاعمري",
...
local BotName = {
"الحمد لله ونته",
"على قول @RFRFF ع الباري ونتَ",
"انا بخير",
}
return LuaTele.sendText(msg_chat_id,msg_id,BotName[math.random(#BotName)],"md",true)   
end
if text == "بوسه" then
local NamesBot = (Redis:get(TheNero.."Nero:Name:Bot") or "Nero")
local BotName = {
"اهممممواح🙈😉.",
"عيع خدك وصخ 😹🏃‍♀️.",
"اوفف اخدر اذاابوسه 🙈😻.",
...
x = x + 1
Redis:srem(TheNero..'Nero:Num:User:Pv',v)
end
end
if x ~= 0 then
...
local Get_Chat = LuaTele.getChat(v)
if Get_Chat.id then
local statusMem = LuaTele.getChatMember(Get_Chat.id,TheNero)
if statusMem.status.luatele == "chatMemberStatusMember" then
x = x + 1
LuaTele.sendText(Get_Chat.id,0,'*⌔ : البوت عظو في المجموعه سوف اغادر ويمكنك تفعيلي مره اخره *',"md")
Redis:srem(TheNero..'Nero:ChekBotAdd',Get_Chat.id)
local keys = Redis:keys(TheNero..'*'..Get_Chat.id)
for i = 1, #keys do
Redis:del(keys[i])
end
...
x = x + 1
local keys = Redis:keys(TheNero..'*'..v)
for i = 1, #keys do
Redis:del(keys[i])
end
Redis:srem(TheNero..'Nero:ChekBotAdd',v)
LuaTele.leaveChat(v)
end
end
if x ~= 0 then
...
Redis:set(TheNero.."Nero:Game:Smile"..msg.chat_id,SM)
...
Redis:set(TheNero.."Nero:Game:Monotonous"..msg.chat_id,name)
...
name = KlamSpeed[math.random(#KlamSpeed)]
Redis:set(TheNero.."mshaher"..msg.chat_id,name)
...
Redis:set(TheNero.."Nero:Game:Riddles"..msg.chat_id,name)
...
if text == "معاني" then
if Redis:get(TheNero.."Nero:Status:Games"..msg.chat_id) then
Redis:del(TheNero.."Nero:Set:Maany"..msg.chat_id)
Maany_Rand = {"قرد","دجاجه","بطريق","ضفدع","بومه","نحله","ديك","جمل","بقره","دولفين","تمساح","قرش","نمر","اخطبوط","سمكه","خفاش","اسد","فأر","ذئب","فراشه","عقرب","زرافه","قنفذ","تفاحه","باذنجان"}
name = Maany_Rand[math.random(#Maany_Rand)]
Redis:set(TheNero.."Nero:Game:Meaningof"..msg.chat_id,name)
...
if Redis:get(TheNero.."Nero:Status:Games"..msg.chat_id) then
Redis:del(TheNero.."Set:Country"..msg.chat_id)
...
Redis:set(TheNero.."Game:Countrygof"..msg.chat_id,name)
...
if text == "العكس" then
if Redis:get(TheNero.."Nero:Status:Games"..msg.chat_id) then
Redis:del(TheNero.."Nero:Set:Aks"..msg.chat_id)
katu = {"باي","فهمت","موزين","اسمعك","احبك","موحلو","نضيف","حاره","ناصي","جوه","سريع","ونسه","طويل","سمين","ضعيف","شريف","شجاع","رحت","عدل","نشيط","شبعان","موعطشان","خوش ولد","اني","هادئ"}
name = katu[math.random(#katu)]
Redis:set(TheNero.."Nero:Game:Reflection"..msg.chat_id,name)
...
Redis:set(TheNero.."Nero:Game:Estimate"..msg.chat_id..msg.sender.user_id,Num)  
...
Redis:set(TheNero.."Nero:Game:Difference"..msg.chat_id,name)
...
Redis:set(TheNero.."Nero:Game:Example"..msg.chat_id,name)
...
local NumberGame = Redis:get(TheNero.."Nero:Num:Add:Games"..msg.chat_id..msg.sender.user_id)
...
Redis:decrby(TheNero.."Nero:Num:Add:Games"..msg.chat_id..msg.sender.user_id,NumGame)  
Redis:incrby(TheNero.."Nero:Num:Message:User"..msg.chat_id..":"..msg.sender.user_id,NumGame)  
...
Redis:incrby(TheNero.."Nero:Num:Add:Games"..msg.chat_id..Message_Reply.sender.user_id, text:match("^اضف مجوهرات (%d+)$"))  
...
Redis:incrby(TheNero.."Nero:Num:Message:User"..msg.chat_id..":"..Message_Reply.sender.user_id, text:match("^اضف رسائل (%d+)$"))  
...
local Num = Redis:get(TheNero.."Nero:Num:Add:Games"..msg.chat_id..msg.sender.user_id) or 0
if Num == 0 then 
...
Redis:set(TheNero.."Nero:Get:Reides:Commands:Group"..msg_chat_id..":"..'تعط','تعطيل الايدي بالصوره')
Redis:set(TheNero.."Nero:Get:Reides:Commands:Group"..msg_chat_id..":"..'تفع','تفعيل الايدي بالصوره')
Redis:set(TheNero.."Nero:Get:Reides:Commands:Group"..msg_chat_id..":"..'ا','ايدي')
Redis:set(TheNero.."Nero:Get:Reides:Commands:Group"..msg_chat_id..":"..'م','رفع مميز')
Redis:set(TheNero.."Nero:Get:Reides:Commands:Group"..msg_chat_id..":"..'اد', 'رفع ادمن')
Redis:set(TheNero.."Nero:Get:Reides:Commands:Group"..msg_chat_id..":"..'مد','رفع مدير')
Redis:set(TheNero.."Nero:Get:Reides:Commands:Group"..msg_chat_id..":"..'من', 'رفع منشئ')
Redis:set(TheNero.."Nero:Get:Reides:Commands:Group"..msg_chat_id..":"..'اس', 'رفع منشئ اساسي')
Redis:set(TheNero.."Nero:Get:Reides:Commands:Group"..msg_chat_id..":"..'مط','رفع مطور')
Redis:set(TheNero.."Nero:Get:Reides:Commands:Group"..msg_chat_id..":"..'تك','تنزيل الكل')
Redis:set(TheNero.."Nero:Get:Reides:Commands:Group"..msg_chat_id..":"..'ر','الرابط')
Redis:set(TheNero.."Nero:Get:Reides:Commands:Group"..msg_chat_id..":"..'رر','ردود المدير')
Redis:set(TheNero.."Nero:Get:Reides:Commands:Group"..msg_chat_id..":"..'،،','مسح المكتومين')
Redis:set(TheNero.."Nero:Get:Reides:Commands:Group"..msg_chat_id..":"..'رد','اضف رد')
Redis:set(TheNero.."Nero:Get:Reides:Commands:Group"..msg_chat_id..":"..'سح','مسح سحكاتي')
Redis:set(TheNero.."Nero:Get:Reides:Commands:Group"..msg_chat_id..":"..'غ','غنيلي')
Redis:set(TheNero.."Nero:Get:Reides:Commands:Group"..msg_chat_id..":"..'رس','رسائلي')
Redis:set(TheNero.."Nero:Get:Reides:Commands:Group"..msg_chat_id..":"..'ثانوي','رفع مطور ثانوي')
...
Redis:sadd(TheNero..'Nero:Num:User:Pv',msg.sender.user_id)  
if not msg.ControllerBot then
if not Redis:get(TheNero.."Nero:Start:Bot") then
local CmdStart = '*\n⌔ : اهلا بك عزيزي في بوت '..(Redis:get(TheNero.."Nero:Name:Bot") or "Nero")..
...
{
{text = '⌔ : شࢪوحات السوࢪس -', url = 't.me/BBI9B'},
},
{
{text = '⌔ : سۅࢪس سناب -', url = 't.me/iinzzz'},
},
}
}
...
{
{text = '⌔ : شࢪوحات السوࢪس', url = 't.me/BBI9B'}, {text = '⌔ : شراء بوت', url = 't.me/RFRFF'},
},
{
{text = '⌔ : 𝗦ηαρ 𝗦??𝙪𝙧𝘤𝙚 ', url = 't.me/iinzzz'},
},
}
}
return LuaTele.sendText(msg_chat_id,msg_id,Redis:get(TheNero.."Nero:Start:Bot"),"md",false, false, false, false, reply_markup)
end
else
...
Redis:setex(TheNero.."Nero:Change:Start:Bot"..msg.sender.user_id,300,true) 
...
Redis:del(TheNero.."Nero:Start:Bot") 
...
LuaTele.sendText(msg_chat_id,msg_id,'*⌔ : عدد احصائيات البوت الكامله \n⋆┄┄─┄─┄─┄┄─┄─┄┄⋆\n⌔ : عدد المجموعات : '..(Redis:scard(TheNero..'Nero:ChekBotAdd') or 0)..'\n⌔ : عدد المشتركين : '..(Redis:scard(TheNero..'Nero:Num:User:Pv') or 0)..'*',"md",true)  
end
if text == 'الرتبه' or text == 'رتبته'  and msg.reply_to_message_id ~= 0 then
local Message_Reply = LuaTele.getMessage(msg.chat_id, msg.reply_to_message_id)
local UserInfo = LuaTele.getUser(Message_Reply.sender.user_id)
...
if not msg.ControllerBot then
if Redis:get(TheNero.."Nero:TwaslBot") and not Redis:sismember(TheNero.."Nero:BaN:In:Tuasl",msg.sender.user_id) then
local ListGet = {Sudo_Id,msg.sender.user_id}
local IdSudo = LuaTele.getChat(ListGet[1]).id
local IdUser = LuaTele.getChat(ListGet[2]).id
local FedMsg = LuaTele.sendForwarded(IdSudo, 0, IdUser, msg_id)
Redis:setex(TheNero.."Nero:Twasl:UserId"..msg.date,172800,IdUser)
...
local Info_User = Redis:get(TheNero.."Nero:Twasl:UserId"..Message_Get.forward_info.date) or 46899864
if text == 'حظر' then
Redis:sadd(TheNero..'Nero:BaN:In:Tuasl',Info_User)  
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Info_User,'⌔ : تم حظره من تواصل البوت ').Reply,"md",true)  
end 
if text =='الغاء الحظر' or text =='الغاء حظر' then
Redis:srem(TheNero..'Nero:BaN:In:Tuasl',Info_User)  
...
Redis:srem(TheNero.."Nero:ChekBotAdd",'-100'..data.supergroup.id)
local keys = Redis:keys(TheNero..'*'..'-100'..data.supergroup.id)
for i = 1, #keys do
Redis:del(keys[i])
end
...
if msg.content.video_note then
if msg.content.video_note.video.remote.id == Redis:get(TheNero.."Nero:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(TheNero.."Nero:PinMsegees:"..msg.chat_id)
end
elseif msg.content.photo then
if msg.content.photo.sizes[1].photo.remote.id then
idPhoto = msg.content.photo.sizes[1].photo.remote.id
...
if idPhoto == Redis:get(TheNero.."Nero:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(TheNero.."Nero:PinMsegees:"..msg.chat_id)
end
elseif msg.content.sticker then 
if msg.content.sticker.sticker.remote.id == Redis:get(TheNero.."Nero:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(TheNero.."Nero:PinMsegees:"..msg.chat_id)
end
elseif msg.content.voice_note then 
if msg.content.voice_note.voice.remote.id == Redis:get(TheNero.."Nero:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(TheNero.."Nero:PinMsegees:"..msg.chat_id)
end
elseif msg.content.video then 
if msg.content.video.video.remote.id == Redis:get(TheNero.."Nero:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(TheNero.."Nero:PinMsegees:"..msg.chat_id)
end
elseif msg.content.animation then 
if msg.content.animation.animation.remote.id ==  Redis:get(TheNero.."Nero:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(TheNero.."Nero:PinMsegees:"..msg.chat_id)
end
elseif msg.content.document then
if msg.content.document.document.remote.id == Redis:get(TheNero.."Nero:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(TheNero.."Nero:PinMsegees:"..msg.chat_id)
end
elseif msg.content.audio then
if msg.content.audio.audio.remote.id == Redis:get(TheNero.."Nero:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(TheNero.."Nero:PinMsegees:"..msg.chat_id)
end
elseif text then
if text == Redis:get(TheNero.."Nero:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(TheNero.."Nero:PinMsegees:"..msg.chat_id)
end
end
...
if Redis:get(TheNero.."Nero:Lock:tagservr"..data.message.chat_id) then
LuaTele.deleteMessages(data.message.chat_id,{[1]= data.message.id})
end
end 
if tonumber(data.message.sender.user_id) == tonumber(TheNero) then
return false
end
if data.message.content.luatele == "messageChatJoinByLink" and Redis:get(TheNero..'Nero:Status:joinet'..data.message.chat_id) == 'true' then
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {
{
...
if Message_Edit.sender.user_id == TheNero then
print('This is Edit for Bot')
return false
end
File_Bot_Run(Message_Edit,Message_Edit)
Redis:incr(TheNero..'Nero:Num:Message:Edit'..data.chat_id..Message_Edit.sender.user_id)
if Message_Edit.content.luatele == "messageContact" or Message_Edit.content.luatele == "messageVideoNote" or Message_Edit.content.luatele == "messageDocument" or Message_Edit.content.luatele == "messageAudio" or Message_Edit.content.luatele == "messageVideo" or Message_Edit.content.luatele == "messageVoiceNote" or Message_Edit.content.luatele == "messageAnimation" or Message_Edit.content.luatele == "messagePhoto" then
if Redis:get(TheNero.."Nero:Lock:edit"..data.chat_id) then
...
io.popen("curl -s 'http://185.185.127.158/Nero/yt2.php?url="..listYt[2].."&token="..Token.."&chat="..ChatId.."&type=ogg&msg=0'")
end
end
...
if tonumber(listYt[1]) == tonumber(IdUser) then
LuaTele.deleteMessages(ChatId,{[1]= Msg_id})
io.popen("curl -s 'http://185.185.127.158/Nero/yt2.php?url="..listYt[2].."&token="..Token.."&chat="..ChatId.."&type=mp3&msg=0'")
end
end
...
if tonumber(listYt[1]) == tonumber(IdUser) then
LuaTele.deleteMessages(ChatId,{[1]= Msg_id})
io.popen("curl -s 'http://185.185.127.158/Nero/yt2.php?url="..listYt[2].."&token="..Token.."&chat="..ChatId.."&type=mp4&msg=0'")
end
end
...
keyboard.inline_keyboard = {
{
{text = '❲ S𝘰𝘶𝘳𝘤𝘦 S𝘯𝘢𝘱 ❳',url="https://t.me/iinzzz"},{text = ' Updates source ⁦ᯓ',url="https://t.me/BBI9B"}
},
{
{text = '  S𝘯𝘢𝘱 ⁦ᯓ',url="https://t.me/RFRFF"}
},
}
local msg_id = Msg_id/2097152/0.5
...
{
{text = '❲ 𝖾𝗂𝗅𝖺??ᴅ 𝖲𝗈𝗎𝗋𝖼𝖾 ❳',url="t.me/iinzzz"}
},
}
local msg_id = Msg_id/2097152/0.5
...
{
{text = '❲ ??𝘯𝘢𝘱 𝖲𝗈𝗎𝗋𝖼𝖾 ❳',url="t.me/iinzzz"}
},
}
https.request("https://api.telegram.org/bot"..Token..'/sendVoice?chat_id=' .. ChatId .. '&voice=https://t.me/TEAMSUL/'..Abs..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
LuaTele.deleteMessages(ChatId,{[1]= Msg_id})
...
https.request("https://api.telegram.org/bot"..Token..'/sendVoice?chat_id=' .. ChatId .. '&voice=https://t.me/shaarNero/'..Abs..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
LuaTele.deleteMessages(ChatId,{[1]= Msg_id})
end
end
...
{
{text = '❲ 𝘴𝘯𝘢𝘱 𝖲𝗈??𝗋𝖼𝖾 ❳',url="t.me/iinzzz"}
},
}
...
Redis:set(TheNero.."Nero:Get:Reides:Commands:Group"..UserId[2]..":"..'تعط','تعطيل الايدي بالصوره')
Redis:set(TheNero.."Nero:Get:Reides:Commands:Group"..UserId[2]..":"..'تفع','تفعيل الايدي بالصوره')
Redis:set(TheNero.."Nero:Get:Reides:Commands:Group"..UserId[2]..":"..'ا','ايدي')
Redis:set(TheNero.."Nero:Get:Reides:Commands:Group"..UserId[2]..":"..'م','رفع مميز')
Redis:set(TheNero.."Nero:Get:Reides:Commands:Group"..UserId[2]..":"..'اد', 'رفع ادمن')
Redis:set(TheNero.."Nero:Get:Reides:Commands:Group"..UserId[2]..":"..'مد','رفع مدير')
Redis:set(TheNero.."Nero:Get:Reides:Commands:Group"..UserId[2]..":"..'من', 'رفع منشئ')
Redis:set(TheNero.."Nero:Get:Reides:Commands:Group"..UserId[2]..":"..'اس', 'رفع منشئ اساسي')
Redis:set(TheNero.."Nero:Get:Reides:Commands:Group"..UserId[2]..":"..'مط','رفع مطور')
Redis:set(TheNero.."Nero:Get:Reides:Commands:Group"..UserId[2]..":"..'تك','تنزيل الكل')
Redis:set(TheNero.."Nero:Get:Reides:Commands:Group"..UserId[2]..":"..'ر','الرابط')
Redis:set(TheNero.."Nero:Get:Reides:Commands:Group"..UserId[2]..":"..'رر','ردود المدير')
Redis:set(TheNero.."Nero:Get:Reides:Commands:Group"..UserId[2]..":"..'،،','مسح المكتومين')
Redis:set(TheNero.."Nero:Get:Reides:Commands:Group"..UserId[2]..":"..'رد','اضف رد')
Redis:set(TheNero.."Nero:Get:Reides:Commands:Group"..UserId[2]..":"..'سح','مسح سحكاتي')
Redis:set(TheNero.."Nero:Get:Reides:Commands:Group"..UserId[2]..":"..'غ','غنيلي')
Redis:set(TheNero.."Nero:Get:Reides:Commands:Group"..UserId[2]..":"..'رس','رسائلي')
Redis:set(TheNero.."Nero:Get:Reides:Commands:Group"..UserId[2]..":"..'ثانوي','رفع مطور ثانوي')
...
if tonumber(listYt[1]) == tonumber(IdUser) then
Redis:srem(TheNero.."Nero:SilentGroup:Group"..ChatId,listYt[2]) 
Redis:srem(TheNero.."Nero:BanGroup:Group"..ChatId,listYt[2]) 
...
if tonumber(listYt) == tonumber(IdUser) then
Redis:del(TheNero.."Nero:Redis:Id:Group"..ChatId..""..IdUser) 
Redis:del(TheNero.."Nero1:Set:Rd"..IdUser..":"..ChatId)
Redis:del(TheNero.."Nero:Set:Manager:rd"..IdUser..":"..ChatId)
Redis:del(TheNero.."Nero:Set:Rd"..IdUser..":"..ChatId)
...
if tonumber(listYt) == tonumber(IdUser) then
Redis:set(TheNero.."Nero:Redis:Id:Group"..ChatId..""..IdUser,true) 
...
if tonumber(listYt) == tonumber(IdUser) then
Redis:set(TheNero.."Nero1:Set:Rd"..IdUser..":"..ChatId, "true")
...
if tonumber(listYt) == tonumber(IdUser) then
Redis:set(TheNero.."Nero:Set:Manager:rd"..IdUser..":"..ChatId,"true")
LuaTele.editMessageText(ChatId,Msg_id,"⌔ : ارسل لي الرد الان", 'md', true)
end
end
...
if tonumber(listYt) == tonumber(IdUser) then
Redis:set(TheNero.."Nero:Set:Rd"..IdUser..":"..ChatId,true)
LuaTele.editMessageText(ChatId,Msg_id,"⌔ : ارسل لي الرد الان", 'md', true)
end
end
...
Redis:incrby(TheNero.."Nero:Num:Add:Games"..ChatId..IdUser, 1)  
...
{
{text = '‹ 𝗦ηαρ ??𝙤𝙪𝙧𝘤𝙚 ‹ ', url = 't.me/iinzzz'}, 
},
}
}
local TextHelp = [[*
⌔ : أهلا بك في قائمة العاب سورس سناب اختر نوع الالعاب 
*]]
LuaTele.editMessageText(ChatId,Msg_id,TextHelp, 'md', true, false, reply_markup)
end
...
local TextHelp = [[*
⌔ : مرحبا بك في الالعاب المتطورة الخاص بسورس سناب 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheNero.."Nero:Lock:Link"..ChatId,"del")  
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheNero.."Nero:Lock:Spam"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheNero.."Nero:Lock:Keyboard"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheNero.."Nero:Lock:vico"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheNero.."Nero:Lock:Animation"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheNero.."Nero:Lock:Document"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheNero.."Nero:Lock:text"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheNero.."Nero:Lock:Video"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheNero.."Nero:Lock:Photo"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheNero.."Nero:Lock:User:Name"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheNero.."Nero:Lock:hashtak"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheNero.."Nero:Lock:Bot:kick"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheNero.."Nero:Lock:forward"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheNero.."Nero:Lock:Audio"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheNero.."Nero:Lock:Sticker"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheNero.."Nero:Lock:Contact"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheNero.."Nero:Lock:Join"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheNero.."Nero:Lock:AddMempar"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheNero.."Nero:Lock:Unsupported"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheNero.."Nero:lockpin"..ChatId,(LuaTele.getChatPinnedMessage(ChatId).id or true)) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheNero.."Nero:Lock:tagservr"..ChatId,true)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheNero.."Nero:Lock:Markdaun"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheNero.."Nero:Lock:edit"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheNero.."Nero:Lock:geam"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:hset(TheNero.."Nero:Spam:Group:User"..ChatId ,"Spam:User","del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheNero.."Nero:Lock:Link"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheNero.."Nero:Lock:Spam"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheNero.."Nero:Lock:Keyboard"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheNero.."Nero:Lock:vico"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheNero.."Nero:Lock:Animation"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheNero.."Nero:Lock:Document"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheNero.."Nero:Lock:Video"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheNero.."Nero:Lock:Photo"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheNero.."Nero:Lock:User:Name"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheNero.."Nero:Lock:hashtak"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheNero.."Nero:Lock:forward"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheNero.."Nero:Lock:Audio"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheNero.."Nero:Lock:Sticker"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheNero.."Nero:Lock:Contact"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheNero.."Nero:Lock:Unsupported"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheNero.."Nero:Lock:Markdaun"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheNero.."Nero:Lock:geam"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:hset(TheNero.."Nero:Spam:Group:User"..ChatId ,"Spam:User","keed")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheNero.."Nero:Lock:Link"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheNero.."Nero:Lock:Spam"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheNero.."Nero:Lock:Keyboard"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheNero.."Nero:Lock:vico"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheNero.."Nero:Lock:Animation"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheNero.."Nero:Lock:Document"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheNero.."Nero:Lock:Video"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheNero.."Nero:Lock:Photo"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheNero.."Nero:Lock:User:Name"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheNero.."Nero:Lock:hashtak"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheNero.."Nero:Lock:forward"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheNero.."Nero:Lock:Audio"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheNero.."Nero:Lock:Sticker"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheNero.."Nero:Lock:Contact"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheNero.."Nero:Lock:Unsupported"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheNero.."Nero:Lock:Markdaun"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheNero.."Nero:Lock:geam"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:hset(TheNero.."Nero:Spam:Group:User"..ChatId ,"Spam:User","mute")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheNero.."Nero:Lock:Link"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheNero.."Nero:Lock:Spam"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheNero.."Nero:Lock:Keyboard"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheNero.."Nero:Lock:vico"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheNero.."Nero:Lock:Animation"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheNero.."Nero:Lock:Document"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheNero.."Nero:Lock:Video"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheNero.."Nero:Lock:Photo"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheNero.."Nero:Lock:User:Name"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheNero.."Nero:Lock:hashtak"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheNero.."Nero:Lock:forward"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheNero.."Nero:Lock:Audio"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheNero.."Nero:Lock:Sticker"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheNero.."Nero:Lock:Contact"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheNero.."Nero:Lock:Unsupported"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheNero.."Nero:Lock:Markdaun"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheNero.."Nero:Lock:geam"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:hset(TheNero.."Nero:Spam:Group:User"..ChatId ,"Spam:User","kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheNero.."Nero:Status:Link"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheNero.."Nero:Status:Welcome"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheNero.."Nero:Status:Id"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheNero.."Nero:Status:IdPhoto"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheNero.."Nero:Status:Reply"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheNero.."Nero:Status:ReplySudo"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheNero.."Nero:Status:SetId"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheNero.."Nero:Status:BanId"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheNero.."Nero:Status:Games"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheNero.."Nero:Status:KickMe"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheNero.."Nero:Status:Link"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheNero.."Nero:Status:Welcome"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheNero.."Nero:Status:Id"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheNero.."Nero:Status:IdPhoto"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheNero.."Nero:Status:Reply"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheNero.."Nero:Status:ReplySudo"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheNero.."Nero:Status:SetId"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheNero.."Nero:Status:BanId"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheNero.."Nero:Status:Games"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheNero.."Nero:Status:KickMe"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if Info_Members.members[k].bot_info == nil then
if Info_Members.members[k].status.luatele == "chatMemberStatusCreator" then
Redis:sadd(TheNero.."Nero:TheBasics:Group"..UserId[2],v.member_id.user_id) 
x = x + 1
else
Redis:sadd(TheNero.."Nero:Addictive:Group"..UserId[2],v.member_id.user_id) 
y = y + 1
end
end
end
...
if tonumber(IdUser) == tonumber(UserId[1]) then
Redis:set(TheNero.."Nero:Lock:tagservrbot"..UserId[2],true)   
list ={"Lock:Bot:kick","Lock:User:Name","Lock:hashtak","Lock:Cmd","Lock:Link","Lock:forward","Lock:Keyboard","Lock:geam","Lock:Photo","Lock:Animation","Lock:Video","Lock:Audio","Lock:vico","Lock:Sticker","Lock:Document","Lock:Unsupported","Lock:Markdaun","Lock:Contact","Lock:Spam"}
for i,lock in pairs(list) do 
Redis:set(TheNero..'Nero:'..lock..UserId[2],"del")    
end
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheNero.."Nero:Lock:Link"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheNero.."Nero:Lock:Spam"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheNero.."Nero:Lock:Keyboard"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheNero.."Nero:Lock:vico"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheNero.."Nero:Lock:Animation"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheNero.."Nero:Lock:Document"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheNero.."Nero:Lock:text"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheNero.."Nero:Lock:Video"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheNero.."Nero:Lock:Photo"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheNero.."Nero:Lock:User:Name"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheNero.."Nero:Lock:hashtak"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheNero.."Nero:Lock:Bot:kick"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheNero.."Nero:Lock:forward"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheNero.."Nero:Lock:Audio"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheNero.."Nero:Lock:Sticker"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheNero.."Nero:Lock:Contact"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheNero.."Nero:Lock:Join"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheNero.."Nero:Lock:AddMempar"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheNero.."Nero:Lock:Unsupported"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheNero.."Nero:lockpin"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheNero.."Nero:Lock:tagservr"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheNero.."Nero:Lock:Markdaun"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheNero.."Nero:Lock:edit"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheNero.."Nero:Lock:geam"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:hdel(TheNero.."Nero:Spam:Group:User"..ChatId ,"Spam:User")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheNero.."Nero:TheBasicsQ:Group"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheNero.."Nero:TheBasics:Group"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheNero.."Nero:Originators:Group"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheNero.."Nero:Managers:Group"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheNero.."Nero:Addictive:Group"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheNero.."Nero:Distinguished:Group"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheNero.."wtka:Group"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheNero.."klb:Group"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheNero.."mar:Group"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheNero.."smb:Group"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheNero.."kholat:Group"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheNero.."8by:Group"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheNero.."3ra:Group"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheNero.."Nero:BanGroup:Group"..ChatId) 
LuaTele.editMessageText(ChatId,Msg_id,"⌔ : تم مسح المحظورين", 'md', false)
end
elseif Text and Text:match('(%d+)/SilentGroupGroup') then
local UserId = Text:match('(%d+)/SilentGroupGroup')
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheNero.."Nero:SilentGroup:Group"..ChatId) 
